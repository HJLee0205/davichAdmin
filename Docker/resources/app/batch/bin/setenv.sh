...
export CATALINA_HOME="/app/batch/"
export CATALINA_BASE="/app/batch/"

export SERVER_NAME="batch"
export JVM_ROUTE="was9998"
export HTTP_PORT="18444"
export HTTPS_PORT=""
export AJP_PORT="4589"
export SHUTDOWN_PORT="18016"
...
export GC_LOG_HOME=/app/logs/batch/gc
...
export CATALINA_OPTS="${CATALINA_OPTS} -XX:HeapDumpPath=/app/logs/batch"
