...
export CATALINA_HOME="/app/mfront/"
export CATALINA_BASE="/app/mfront/"

export SERVER_NAME="mfront"
export JVM_ROUTE="was9"
export HTTP_PORT=""
export HTTPS_PORT=""
export AJP_PORT="8081"
export SHUTDOWN_PORT="38015"
...
export GC_LOG_HOME=/app/logs/mfront/gc
...
export CATALINA_OPTS="${CATALINA_OPTS} -XX:HeapDumpPath=/app/logs/mfront"
export CATALINA_OPTS="${CATALINA_OPTS} -Djava.security.egd=file:/dev/./urandom"

# 리모트 디버깅
export JPDA_ADDRESS=5003
