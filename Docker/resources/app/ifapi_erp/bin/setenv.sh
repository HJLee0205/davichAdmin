...
export CATALINA_HOME="/app/ifapi_erp/"
export CATALINA_BASE="/app/ifapi_erp/"

export SERVER_NAME="ifapi_erp"
export JVM_ROUTE="was14"
export HTTP_PORT=""
export HTTPS_PORT=""
export AJP_PORT="9999"
export SHUTDOWN_PORT="8017"
...
export GC_LOG_HOME=/app/logs/ifapi_erp/gc
...
export CATALINA_OPTS="${CATALINA_OPTS} -XX:HeapDumpPath=/app/logs/ifapi_erp"
export CATALINA_OPTS="${CATALINA_OPTS} -Djava.security.egd=file:/dev/./urandom"

# 리모트 디버깅
export JPDA_ADDRESS=5004
