...
export CATALINA_HOME="/app/ifapi_mall/"
export CATALINA_BASE="/app/ifapi_mall/"

export SERVER_NAME="ifapi_mall"
export JVM_ROUTE="was12"
export HTTP_PORT=""
export HTTPS_PORT=""
export AJP_PORT="9998"
export SHUTDOWN_PORT="28016"
...
export GC_LOG_HOME=/app/logs/ifapi_mall/gc
...
export CATALINA_OPTS="${CATALINA_OPTS} -XX:HeapDumpPath=/app/logs/ifapi_mall"
