...
public class ProxyPushDao {
    ...
    private SqlSessionTemplate sqlSessionTemplatePush;
    ...
    private <E> ResultListModel<E> getResult(String statement, BaseSearchVO<?> baseSearchVO, int filterdRows,
        ...
        List<E> list = this.sqlSessionTemplatePush.selectList(statement, baseSearchVO);
    ...
    private int count(String statement) {
        Object resultObj = this.sqlSessionTemplatePush.selectOne(statement);
    ...
    private int countByParam(String statement, BaseSearchVO<?> baseSearchVO) {
        Object resultObj = this.sqlSessionTemplatePush.selectOne(statement, baseSearchVO);
        if (resultObj instanceof Number) {
            Number number = (Number) resultObj;
            return number.intValue();
        } else {
    ...
    public <T> T selectOne(String statement) {
        log(statement);
        return decodeModel((T)this.sqlSessionTemplatePush.selectOne(statement));
    }

    public <T> T selectOne(String statement, Object parameter) {
        log(statement, parameter);
        T result = this.sqlSessionTemplatePush.selectOne(statement, parameter);
        return decodeModel(result);
    }

//    public <K, V> Map<K, V> selectMap(String statement, String mapKey) {
//        log(statement, mapKey);
//        return this.sqlSessionTemplatePush.selectMap(statement, mapKey);
//    }

    public <E> List<E> selectList(String statement) {
        log(statement);
        return (List<E>) decodeList(this.sqlSessionTemplatePush.selectList(statement));
    }

    public <E> List<E> selectList(String statement, Object parameter) {
        log(statement, parameter);
        return (List<E>) decodeList(this.sqlSessionTemplatePush.selectList(statement, parameter));
    }

    public <E> List<E> selectList(String statement, Object parameter, RowBounds rowBounds) {
        log(statement, parameter);
        return (List<E>) decodeList(this.sqlSessionTemplatePush.selectList(statement, parameter, rowBounds));
    }

//    public void select(String statement, ResultHandler<?> handler) {
//        log(statement);
//        this.sqlSessionTemplatePush.select(statement, handler);
//    }

//    public void select(String statement, Object parameter, ResultHandler<?> handler) {
//        log(statement);
//        this.sqlSessionTemplatePush.select(statement, parameter, handler);
//    }

//    public void select(String statement, Object parameter, RowBounds rowBounds, ResultHandler<?> handler) {
//        log(statement, parameter);
//        this.sqlSessionTemplatePush.select(statement, parameter, rowBounds, handler);
//    }

    public int insert(String statement) {
        log(statement);
        return this.sqlSessionTemplatePush.insert(statement);
    }

    public int insert(String statement, Object parameter) {
        log(statement, parameter);
        return this.sqlSessionTemplatePush.insert(statement, parameter);
    }

    public int update(String statement) {
        log(statement);
        return this.sqlSessionTemplatePush.update(statement);
    }

    public int update(String statement, Object parameter) {
        log(statement, parameter);
        return this.sqlSessionTemplatePush.update(statement, parameter);
    }

    public int delete(String statement) {
        log(statement);
        return this.sqlSessionTemplatePush.delete(statement);
    }

    public int delete(String statement, Object parameter) {
        log(statement, parameter);
        return this.sqlSessionTemplatePush.delete(statement, parameter);
    }

    // public <T> T selectOne(sqlSessionTemplatePush sqlSessionTemplatePush, String statement) {
    // log(statement);
    // return sqlSessionTemplatePush.selectOne(statement);
    // }
    //
    // public <T> T selectOne(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.selectOne(statement, parameter);
    // }
    //
    // public <K, V> Map<K, V> selectMap(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, String mapKey) {
    // log(statement, mapKey);
    // return sqlSessionTemplatePush.selectMap(statement, mapKey);
    // }
    //
    // public <E> List<E> selectList(sqlSessionTemplatePush sqlSessionTemplatePush, String statement) {
    // log(statement);
    // return sqlSessionTemplatePush.selectList(statement);
    // }
    //
    // public <E> List<E> selectList(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.selectList(statement, parameter);
    // }
    //
    // public <E> List<E> selectList(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter,
    // RowBounds rowBounds) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.selectList(statement, parameter, rowBounds);
    // }
    //
    // public void select(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, ResultHandler<?> handler) {
    // log(statement);
    // sqlSessionTemplatePush.select(statement, handler);
    // }
    //
    // public void select(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter,
    // ResultHandler<?> handler) {
    // log(statement);
    // sqlSessionTemplatePush.select(statement, parameter, handler);
    // }
    //
    // public void select(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter, RowBounds
    // rowBounds,
    // ResultHandler<?> handler) {
    // log(statement, parameter);
    // sqlSessionTemplatePush.select(statement, parameter, rowBounds, handler);
    // }
    //
    // public int insert(sqlSessionTemplatePush sqlSessionTemplatePush, String statement) {
    // log(statement);
    // return sqlSessionTemplatePush.insert(statement);
    // }
    //
    // public int insert(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.insert(statement, parameter);
    // }
    //
    // public int update(sqlSessionTemplatePush sqlSessionTemplatePush, String statement) {
    // log(statement);
    // return sqlSessionTemplatePush.update(statement);
    // }
    //
    // public int update(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.update(statement, parameter);
    // }
    //
    // public int delete(sqlSessionTemplatePush sqlSessionTemplatePush, String statement) {
    // log(statement);
    // return sqlSessionTemplatePush.delete(statement);
    // }
    //
    // public int delete(sqlSessionTemplatePush sqlSessionTemplatePush, String statement, Object parameter) {
    // log(statement, parameter);
    // return sqlSessionTemplatePush.delete(statement, parameter);
    // }
    //
    // public <T> T selectOne(int key, String statement) {
    // log(statement);
    // return getsqlSessionTemplatePush(key).selectOne(statement);
    // }
    //
    // public <T> T selectOne(int key, String statement, Object parameter) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).selectOne(statement, parameter);
    // }
    //
    // public <K, V> Map<K, V> selectMap(int key, String statement, String mapKey) {
    // log(statement, mapKey);
    // return getsqlSessionTemplatePush(key).selectMap(statement, mapKey);
    // }
    //
    // public <E> List<E> selectList(int key, String statement) {
    // log(statement);
    // return getsqlSessionTemplatePush(key).selectList(statement);
    // }
    //
    // public <E> List<E> selectList(int key, String statement, Object parameter) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).selectList(statement, parameter);
    // }
    //
    // public <E> List<E> selectList(int key, String statement, Object parameter, RowBounds rowBounds) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).selectList(statement, parameter, rowBounds);
    // }
    //
    // public void select(int key, String statement, ResultHandler<?> handler) {
    // log(statement);
    // getsqlSessionTemplatePush(key).select(statement, handler);
    // }
    //
    // public void select(int key, String statement, Object parameter, ResultHandler<?> handler) {
    // log(statement);
    // getsqlSessionTemplatePush(key).select(statement, parameter, handler);
    // }
    //
    // public void select(int key, String statement, Object parameter, RowBounds rowBounds, ResultHandler<?> handler) {
    // log(statement, parameter);
    // getsqlSessionTemplatePush(key).select(statement, parameter, rowBounds, handler);
    // }
    //
    // public int insert(int key, String statement) {
    // log(statement);
    // return getsqlSessionTemplatePush(key).insert(statement);
    // }
    //
    // public int insert(int key, String statement, Object parameter) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).insert(statement, parameter);
    // }
    //
    // public int update(int key, String statement) {
    // log(statement);
    // return getsqlSessionTemplatePush(key).update(statement);
    // }
    //
    // public int update(int key, String statement, Object parameter) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).update(statement, parameter);
    // }
    //
    // public int delete(int key, String statement) {
    // log(statement);
    // return getsqlSessionTemplatePush(key).delete(statement);
    // }
    //
    // public int delete(int key, String statement, Object parameter) {
    // log(statement, parameter);
    // return getsqlSessionTemplatePush(key).delete(statement, parameter);
    // }
