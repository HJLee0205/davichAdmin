...
public class ProxyDao {
    ...
    public <T> T selectOne(String statement) {
        log(statement);
        return decodeModel((T) this.sqlSessionTemplate.selectOne(statement));
    }

    public <T> T selectOne(String statement, Object parameter) {
        log(statement, parameter);
        T result = this.sqlSessionTemplate.selectOne(statement, parameter);
        return decodeModel(result);
    }

    public <T> T selectOneNolog(String statement, Object parameter) {
        T result = this.sqlSessionTemplate.selectOne(statement, parameter);
        return decodeModel(result);
    }
...
//    }
    ...
    // }
    //
    // public void select(SqlSessionTemplate sqlSessionTemplate, String statement, Object parameter, RowBounds
    // rowBounds,
    // ResultHandler<?> handler) {
    // log(statement, parameter);
    ...
    private void log(String statement, Object parameter) {
        ...
        log.info("= {}", statement);
        if (parameter != null) {
           //log.info("parameter = {}", ToStringBuilder.reflectionToString(parameter, ToStringStyle.MULTI_LINE_STYLE));
