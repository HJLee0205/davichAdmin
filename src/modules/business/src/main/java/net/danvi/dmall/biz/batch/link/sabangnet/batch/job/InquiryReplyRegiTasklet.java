 ...
 * </pre>
 */
public class InquiryReplyRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setIfId(SabangnetConstant.IF_ID_INQUIRY_REPLY);
        vo.setIfPgmId(SabangnetConstant.IF_PGM_ID_INQUIRY_REPLY);
        vo.setIfPgmNm(SabangnetConstant.IF_PGM_NM_INQUIRY_REPLY);
        ...
        sabangnetService.registInquiryReply(vo, domain); // 사방넷서비스.문의답변등록
