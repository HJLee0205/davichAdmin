 ...
 * 작성일     : 2016. 8. 23
 * 작성자     : dong
 * 설명       : 방문자IP분석 집계 Tasklet
 * </pre>
 */
public class VstrIpAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_VSTR_IP_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_VSTR_IP_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_VSTR_IP_ANLS);

        sttcsService.registVstrIpAnls(vo); // 통계서비스.방문자IP분석 집계
