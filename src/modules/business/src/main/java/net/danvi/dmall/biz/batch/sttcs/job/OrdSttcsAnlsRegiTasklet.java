 ...
 * 작성일     : 2016. 8. 30
 * 작성자     : dong
 * 설명       : 주문통계분석 집계 Tasklet
 * </pre>
 */
public class OrdSttcsAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_ORD_STTCS_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_ORD_STTCS_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_ORD_STTCS_ANLS);

        sttcsService.registOrdSttcsAnls(vo); // 통계서비스.주문통계분석 집계
