 ...
 * 작성일     : 2016. 6. 28.
 * 작성자     : dong
 * 설명       : 사방넷 연계 클래임 수집을 위한 클래스
 * </pre>
 */
@Data
public class ClaimResult extends SabangnetData {
    private static final long serialVersionUID = -929952411630595109L;
    ...
    private String clameStatusGubun;
    private String clameContent;
    private String clameInsDate;
    private String clameRegDate;
