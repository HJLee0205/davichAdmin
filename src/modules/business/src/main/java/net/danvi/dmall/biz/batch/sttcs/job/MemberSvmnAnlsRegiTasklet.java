 ...
 * 작성일     : 2016. 8. 23
 * 작성자     : dong
 * 설명       : 회원마켓포인트분석 집계 Tasklet
 * </pre>
 */
public class MemberSvmnAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_MEMBER_SVMN_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_MEMBER_SVMN_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_MEMBER_SVMN_ANLS);

        sttcsService.registMemberSvmnAnls(vo); // 통계서비스.회원마켓포인트분석 집계
