package net.danvi.dmall.biz.ifapi.cmmn.constant;


/**
 * <pre>
 * - 프로젝트명    : davichmall_interface
 * - 패키지명      : net.danvi.dmall.admin.ifapi.cmmn.constant
 * - 파일명        : Constants.java
 * - 작성일        : 2018. 5. 18.
 * - 작성자        : CBK
 * - 설명          : 공통상수
...
public class Constants {
	...
	public final class IFID {
		...
		/** 상품 filter 목록 조회 */
		public static final String PRODUCT_FILTER_SEARCH = "IF_PRD_010";

		/** 매장수령상품 판매완료 **/
		public static final String OFF_RECV_COMPLT = "IF_SAL_001";
		/** 오프라인 구매내역 조회 */
		public static final String OFF_SAL_SEARCH = "IF_SAL_002";
        /** 오프란인 매장수령 픽업 시 반품요청 210 **/
        public static final String OFF_RECV_RETURN = "IF_SAL_003";
