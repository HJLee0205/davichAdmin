 ...
 * 작성일     : 2016. 8. 23
 * 작성자     : dong
 * 설명       : 장바구니 상품분석 집계 Tasklet
 * </pre>
 */
public class BasketGoodsAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_BASKET_GOODS_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_BASKET_GOODS_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_BASKET_GOODS_ANLS);

        sttcsService.registBasketGoodsAnls(vo); // 통계서비스.장바구니 상품분석 집계
