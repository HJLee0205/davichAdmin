 ...
 * </pre>
 */
public class GoodsSmrUpdTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setIfId(SabangnetConstant.IF_ID_GOODS_SMR_UPD);
        vo.setIfPgmId(SabangnetConstant.IF_PGM_ID_GOODS_SMR_UPD);
        vo.setIfPgmNm(SabangnetConstant.IF_PGM_NM_GOODS_SMR_UPD);
        ...
        sabangnetService.smrUpdGoods(vo, domain); // 사방넷서비스.상품요약수정
