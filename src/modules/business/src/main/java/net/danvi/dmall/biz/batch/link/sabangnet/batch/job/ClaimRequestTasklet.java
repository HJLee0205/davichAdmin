 ...
 * 작성일     : 2016. 7. 15.
 * 작성자     : dong
 * 설명       : 클레임 정보 수집 Tasklet
 * </pre>
 */
@Slf4j
public class ClaimRequestTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setIfPgmNm(SabangnetConstant.IF_PGM_NM_CLAIM);
        ...
        log.debug("5.0.클레임수집 Tasklet fileName : {}", fileName);

        sabangnetService.getherClaim(domain, fileName, vo); // 사방넷서비스.클레임수집
