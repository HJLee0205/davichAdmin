package net.danvi.dmall.biz.ifapi.dist.service;

import java.util.List;

import net.danvi.dmall.biz.ifapi.dist.dto.ErpReturnConfirmReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.OrderCancelReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.OrderRegReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.OrderReleaseReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.PurchaseConfirmReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.RefundCmpltReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.ReturnPopUrlReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.MallReturnConfirmReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.StoreDlvrCmpltReqDTO;
import net.danvi.dmall.biz.ifapi.dist.dto.OrderReleaseResDTO.ReleaseFailDTO;

/**
 * <pre>
 * - 프로젝트명    : davichmall_interface
 * - 패키지명      : net.danvi.dmall.admin.ifapi.dist.service
