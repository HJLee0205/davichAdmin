 ...
 * 작성일     : 2016. 8. 23
 * 작성자     : dong
 * 설명       : 방문경로분석 집계 Tasklet
 * </pre>
 */
public class VisitPathAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_VISIT_PATH_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_VISIT_PATH_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_VISIT_PATH_ANLS);

        sttcsService.registVisitPathAnls(vo); // 통계서비스.방문경로분석 집계
