...
@Data
@EqualsAndHashCode
public class SellerPO extends EditorBasePO<SellerPO> {
    ...
    private String storeInquiryReply;   // 입점 문의 답변
    private Long replyRegrNo;   // 입점 문의 답변 등록자 번호
    private Long replyUpdrNo;   // 입점 문의 답변 수정자 번호
