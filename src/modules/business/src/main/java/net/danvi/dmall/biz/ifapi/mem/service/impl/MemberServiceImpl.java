...
import net.danvi.dmall.biz.ifapi.cmmn.mapp.dto.OffPointMapRegReqDTO;
...
import net.danvi.dmall.biz.ifapi.mem.dto.MallVCResultResDTO.MallVCResultDTO;
import net.danvi.dmall.biz.ifapi.mem.dto.MemberOffLevelResDTO.MemberOffLevelDTO;
import net.danvi.dmall.biz.ifapi.mem.dto.MemberYearEndTaxResDTO.YearEndTaxInfo;
import net.danvi.dmall.biz.ifapi.mem.dto.OfflineMemSearchResDTO.OfflineMemInfo;
import net.danvi.dmall.biz.ifapi.mem.dto.OnlineMemSearchResDTO.OnlineMemInfo;
import net.danvi.dmall.biz.ifapi.mem.dto.StoreVCResultResDTO.VCRecoGoodsDTO;
import net.danvi.dmall.biz.ifapi.mem.dto.StoreVCResultResDTO.VCResultDTO;
 ...
 * - 패키지명      : net.danvi.dmall.admin.ifapi.mem.service.impl
...
public class MemberServiceImpl extends BaseService implements MemberService {
	...
	public List<OfflineMemInfo> getOfflineMemberInfo(OfflineMemSearchReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectOfflineMemberList", param);
	}
	 ...
	 */
//	@Transactional(transactionManager="transactionManager1", rollbackFor= CustomIfException.class)
	@Override
	public String insertMemberMapAndSend(MemberCombineReqDTO param, String ifId) throws Exception {
		...
		if(Constants.RESULT.FAILURE.equals(resDto.getResult())) {
			// 실패면 등록한 데이터 롤백
			throw new CustomIfException(resDto.getMessage());
		}
	 ...
	 */
//	@Transactional(transactionManager="transactionManager1", rollbackFor= {CustomIfException.class, Exception.class})
	@Override
	...
	public int deleteMemberCombineInfoFromErp(MemberCombineReqDTO param) throws Exception {
		return proxyDao.update("member.deleteMemberCombineInfo", param);
	}
	...
	public void deleteMemberCombineInfoFromMall(MemberCombineReqDTO param) throws Exception {
		...
		// 통합회원구분코드 조회
		String combineGbCd = proxyDao.selectOne("member.selectCombineGbCd", param);
	...
	public List<MemberOffLevelDTO> selectErpMemberLvl() throws Exception {
		/*return proxyDao.selectErpMemberLvl();*/
		// mall에서는 사용하지 않음
		return null;
	}
	...
	public void updateErpMemberLvl() throws Exception {
			proxyDao.update("member.updateMemberLvl");
	}
	...
	public int getOfflineAvailPoint(OffPointSearchReqDTO param) throws Exception {
		return proxyDao.selectOne("member.selectOfflineAvailPoint", param);
	}
	...
	public List<OffPointHistorySearchResDTO.PointHistoryDTO> getOfflinePointHistory(OffPointHistorySearchReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectOfflinePointHistory", param);
	}
	...
	public int countOfflinePointHistory(OffPointHistorySearchReqDTO param) throws Exception {
		return proxyDao.selectOne("member.countOfflinePointHistory", param);
	}
	...
	public List<VCResultDTO> getLatestStoreVisionCheckResultList(StoreVCResultReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectLatestStoreVisionCheck", param);
	}
	...
	public List<VCRecoGoodsDTO> getLatestStoreVisionCheckRecoPrdList(StoreVCResultReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectLatestStoreVisionCheckRecoPrdList", param);
	}
	...
	public List<MallVCResultDTO> getLatestMallVisionCheckList(MallVCResultReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectLastestMallVisionCheck", param);
	}
	...
	public StoreEyesightInfoResDTO getLatestStoreEyesightInfo(StoreEyesightInfoReqDTO param) throws Exception {
		return proxyDao.selectOne("member.selectLatestStoreEyesightInfo", param);
	}
	...
	public MallEyesightInfoResDTO getLatestMallEyesightInfo(MallEyesightInfoReqDTO param) throws Exception {
		return proxyDao.selectOne("member.selectLatestMallEyesightInfo", param);
	}
	...
	public String getLatestPrescriptionImageURL(PrescriptionUrlReqDTO param) throws Exception {
		String fileId = proxyDao.selectOne("member.selectPrescriptionFileId", param);
...
//	@Transactional(transactionManager="transactionManager2", rollbackFor=Exception.class)
	public synchronized List<String> useOfflinePoint(OffPointUseReqDTO param) throws Exception {
		...
		if(availOffPoint < param.getUseOffPointAmt().intValue()) {
			// 보유 포인트가 부족합니다.
			throw new CustomIfException("ifapi.exception.onpoint.overuse");
		}

		// 가맹점별 포인트 목록 조회
		List<Map<String, Object>> strPntList = proxyDao.selectList("member.selectStorePointList", offPointSearchParam.getCdCust());
		for(Map<String, Object> strPnt : strPntList) {
			...
			// 트랜잭션번호 조회 및 설정
			useDto.setTrxnNo(proxyDao.selectOne("member.getTrxnNo", useDto));

			// 저장
			proxyDao.insert("member.insertOfflinePointUse", useDto);
...
//	@Transactional(transactionManager="transactionManager2", rollbackFor=Exception.class)
	public synchronized List<String> cancelOfflinePointUse(OffPointUseCancelReqDTO param) throws Exception {
		// 원 사용 포인트 목록 조회
		List<OffPointUseDTO> useList = proxyDao.selectList("member.selectOfflinPointUseList", param);
	...
	public String onlineCardNoDupCheckWithOfflineCardNo(OfflineCardNoDupCheckReqDTO param) throws Exception {
		// 중복 데이터 개수 조회
		int dupCnt = proxyDao.selectOne("member.countDupOfflineCardNo", param);
		if(dupCnt > 0) {
			// 데이터가 있으면 Y
			return "Y";
		} else {
	 ...
	 */
	@Override
//	@Transactional(transactionManager="transactionManager", rollbackFor={Exception.class, CustomIfException.class, dmall.framework.common.exception.CustomException.class})
	public String memberJoinFromStore(StoreMemberJoinReqDTO param) throws Exception {
        ...
        // 매장가입여부를 Y로 갱신
		proxyDao.update("member.updateStoreJoinYnToY", resultPo.getData().getMemberNo().toString());
...
/**
	...
	public int updateMemberLoginDateFromApp(AppMemberLoginReqDTO param) throws Exception {
		// 앱로그인 일시 다비전 기록
		return proxyDao.update("member.updateMemberLoginDateFromApp", param);
	}
	...
	public List<YearEndTaxInfo> getMemberYearEndTaxList(MemberYearEndTaxReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectYearEndTaxList", param);
	}
	...
	public List<YearEndTaxInfo> getMemberYearEndTaxPrint(MemberYearEndTaxReqDTO param) throws Exception {
		return proxyDao.selectList("member.selectYearEndTaxPrint", param);
	}
...
//		// 앱로그인 일시 다비전 기록
//		return proxyDao.updateMemberYearEndTaxAuto(param);
//	}		
