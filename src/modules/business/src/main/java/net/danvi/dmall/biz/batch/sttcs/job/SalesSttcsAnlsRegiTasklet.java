 ...
 * 작성일     : 2016. 8. 30
 * 작성자     : dong
 * 설명       : 매출통계분석 집계 Tasklet
 * </pre>
 */
public class SalesSttcsAnlsRegiTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        vo.setBtId(SttcsConstant.BT_ID_SALES_STTCS_ANLS);
        vo.setBtPgmId(SttcsConstant.BT_PGM_ID_SALES_STTCS_ANLS);
        vo.setBtPgmNm(SttcsConstant.BT_PGM_NM_SALES_STTCS_ANLS);

        sttcsService.registSalesSttcsAnls(vo); // 통계서비스.매출통계분석 집계
