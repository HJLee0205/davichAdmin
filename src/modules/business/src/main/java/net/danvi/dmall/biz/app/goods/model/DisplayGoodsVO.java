...
@Data
@EqualsAndHashCode
public class DisplayGoodsVO extends BaseModel<DisplayGoodsVO> {
    // private String siteNo;
	
	private String mainAreaGbCd; // 메인 전시 영역 구분
	private String mainAreaGbNm; // 메인 전시 영역 이름
    private String siteDispSeq; // 메인 전시 순번
    private String dispSeq; // 전시 순번
    private String dispTitle; // 전시 타이틀
    ...
    private String goodsImg02; // 상품 이미지 02
    private String goodsImg03; // 상품 이미지 03
    private String goodsImg04; // 상품 이미지 04
    private String goodsImg05; // 상품 이미지 05
    private String goodsImg06; // 상품 이미지 06
    private String brandNo; // 브랜드 번호
    private String brandNm; // 브랜드 명
    private String smrGoodsNm; // 요약상품명
    private String prWords; // 상품 흥보 문구
    private String customerPrice; // 소비자 가격
    private String saleRate; // 할인율
    private String iconImgs; // 아이콘 이미지
    private String goodsSvmnAmt; // 상품 마켓포인트
    private String goodsScore; // 상품 점수
    private String accmGoodslettCnt; // 상품 리뷰 개수
    private String itemNo; // 단품 번호
    private String itemNm; // 단품 명
    private String stockQtt; // 재고 수량
    private String tgDelYn; // tg삭제 여부
    private String tiDelYn; // ti삭제 여부

    private String ctgDispzoneNo; // 카테고리 전시 존 번호
    private String ctgDispDispTypeCd; // 카테고리 전시 전시 유형 코드
    private String ctgNo; // 카테고리 번호
    private String dispYn; // 전시여부
    private String dlgtCtgYn; // 대표 카테고리 여부
    private String expsPriorRank; // 노출 우선 순위
    private String delYn; // 삭제 여부
    private String goodsSaleStatusCd; // 상품 판매 상태 코드
    private String goodsSaleStatusNm; // 상품 판매 상태 코드 명
    private String adultCertifyYn; // 성인 인증 여부
    private String limitCnt; // 제한 개수
    ...
    private List<GoodsVO> displayGoodsMoArr;
    private long maxSiteDispSeq;//메인 전시 마지막 순번
    private List<DisplayGoodsVO> mainAreaTypeA;
    private List<DisplayGoodsVO> mainAreaTypeB;
    private List<DisplayGoodsVO> mainAreaTypeC;
