...
//		return proxyDao.selectList("member.selectOnlineMemberCardList", param);
	 ...
	 * @throws Exception
	 */
	public void updateMemberLvl(MemberOffLevelDTO param) throws Exception {
		sqlSession1.update("member.updateMemberLvl", param);
	}
...
//		proxyDao.update("member.updateStoreJoinYnToY", memberNo);
	...
	public BeaconDataResDTO searchBeacon(BeaconDataReqDTO param) throws Exception {
		return sqlSession2.selectOne("member.selectBeaconData", param);
	}	
}
