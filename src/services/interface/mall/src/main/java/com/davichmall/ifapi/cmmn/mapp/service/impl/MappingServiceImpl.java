...
import com.davichmall.ifapi.cmmn.mapp.dto.*;
...
public class MappingServiceImpl implements MappingService {
	...
	public String getMallMemberLoginId(String erpMemberNo) throws Exception {
		return mappingDao.getMallMemberLoginId(erpMemberNo);
	}
	...
	public void insertMemberMap(String mallMemberNo, String erpMemberNo, String erpMemberLvl) throws Exception {
		...
		if(existErpMemNo != null) {
			// 이미 통합된 회원입니다.
			throw new CustomException("ifapi.exception.member.combine.already", new Object[] { "<br><br> 오프라인 통합회원 번호는 <b> "+ existErpMemNo +"</b> 입니다."});
		}
		...
		if(existMallMemNo != null) {
			...
			// 이미 통합된 회원입니다.
			throw new CustomException("ifapi.exception.member.combine.already", new Object[] { "<br><br> 통합회원 ID 는 <b>" + existMallMemLoginId + "</b> 입니다."});
		}
