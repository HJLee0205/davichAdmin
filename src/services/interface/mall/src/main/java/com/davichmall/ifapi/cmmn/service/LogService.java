package com.davichmall.ifapi.cmmn.service;
 ...
 * - 패키지명      : com.davichmall.ifapi.cmmn.service
 * - 파일명        : LogService.java
 * - 작성일        : 2018. 5. 18.
 * - 작성자        : CBK
...
public interface LogService {
	 ...
	 * @throws Exception
	 */
	void writeInterfaceLog(String ifId, Object reqParam, BaseResDTO resParam, CustomException ce);
}
