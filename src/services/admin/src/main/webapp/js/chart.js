...
jui.define("chart.theme.jennifer", [], function() {
    ...
    return {
        ...
        topologyNodeTitleFontColor : "#222",
        topologyEdgeWidth : 1,
        ...
        topologyTooltipFontColor : "#222",

        timelineTitleFontSize: 10,
        timelineTitleFontColor: "#222",
        timelineTitleFontWeight: 700,
        timelineColumnFontSize: 10,
        timelineColumnFontColor: "#222",
