<%@ tag language="java" body-content="scriptless" pageEncoding="utf-8" description="공통코드를 이용한 값 지원" trimDirectiveWhitespaces="true" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ tag import="java.util.StringTokenizer" %>
<%@ attribute name="codeStr" required="true" description="코드 데이터 문자열 예):전체;Y:동의;N:거부" %>
<%@ attribute name="value" required="false" description="태그의 값" %>
<%
    int index = 1;
    String selected;
    String on;
