...
<%@ attribute name="type" required="true" description="검색 item type" type="java.lang.String" %>
...
%>
<div class="line_box pb"<%= idStr %>>
    <div class="top_lay">
        <div class="select_btn_left">
            <div class="search_txt">
                총 <strong class="be">${resultListModel.filterdRows}</strong>개의 <%= itemType %>(이)가 검색되었습니다.
            </div>
        </div>
