...
<c:if test="${uri.startsWith('/admin/setup')}">
    <c:set var="glCurrent0" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/goods')}">
    <c:set var="glCurrent1" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/order')}">
    <c:set var="glCurrent2" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/member')}">
    <c:set var="glCurrent3" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/board')}">
    <c:set var="glCurrent4" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/operation')}">
    <c:set var="glCurrent5" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/promotion')}">
    <c:set var="glCurrent6" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/design')}">
    <c:set var="glCurrent7" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/seller')}">
    <c:set var="glCurrent8" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
<c:if test="${uri.startsWith('/admin/statistics')}">
    <c:set var="glCurrent9" value=" class=\"gnb_menu_ttl active\""/>
</c:if>
...
<header id="header">
    ...
    <div class="head">
        <h1 id="logo">
            <a href="/admin/main/main-view"><img src="/admin/img/header/logo.png" alt="홈으로 이동"></a>
        </h1>
        <nav>
            ...
            <c:forEach var="menu" items="${_menu}" varStatus="menuStatus">
                ...
                <c:choose>
                    <c:when test="${menuLength eq '2' && menu.menuId eq curMenu}">
                        <li class="gnb_menu">
                            <c:set var="url" value="/admin/common/menu-redirect?menuId=${menu.menuId}"/>
                ...
                <div class="user_nav">
                    ...
                    <ul class="user_items_wrap">
                        <li class="user_items">
                            ...
                            <span class="ml10"><sec:authentication property="details.session.memberNm"></sec:authentication>님</span>
                        </li>
                        <li class="user_items">
