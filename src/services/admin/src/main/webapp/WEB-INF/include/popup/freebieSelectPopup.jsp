                    ...
                    <table summary="이표는 사은품검색 리스트 표 입니다. 구성은 사은품명, 판매가격, 판매상태, 등록 입니다.">
                        ...
                        <tbody id="tbody_popup_freebie_data">
                            <tr id="tr_popup_freebie_data_template" >
                                <td><img src="" data-bind="popFreebieInfo" data-bind-type="img" data-bind-value="freebieImg"></td>

                                <td class="txtl" data-bind="popFreebieInfo" data-bind-type="string" data-bind-value="freebieNm"></td>
