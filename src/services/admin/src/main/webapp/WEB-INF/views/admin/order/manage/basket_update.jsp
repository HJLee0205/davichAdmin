        ...
        if (optAdd) {
            ...
            if (itemInfo != '') {
                ...
                if(addLayer) {
                    ...
                    optObj += '            <button type="button" class="btn_goods_del" onclick="deleteLine(this);"><img src="/product/btn_goods_del.gif" alt=""></button>';
                    optObj += '        </div>';
                    optObj += '    </div>';
                    optObj += '</li>';
...
function basketAddOptInfo(){
    ...
    var obj = JSON.parse(basketOptInfo); //단품정보
...
<!-- layer_popup1 -->
    <div class="popup_header">
        ...
        <button type="button" id="btn_close_pop" class="btn_close_popup">팝업창닫기</button>
    </div>
    <form name="goods_form" id="goods_form">
    <div class="popup_content">
        <div class="popup_goods_plus_img">
            <img src="/popop_product_img01.gif" alt="">
        </div>          
        ...
        <div class="goods_plus_info">
            <ul>
                ...
                <li><span>사은품</span><button type="button" id="btn_view_freebie" class="btn_cart_s04">사은품 보기</button></li>
            </ul>
        </div>
