    ...
    <script>
      $(document).ready(function() {
        ...
        Dmall.AjaxUtil.getJSON(url, param, function(result) {
          // json 데이터 바인딩
          Dmall.FormUtil.jsonToForm(result.data, 'form_collection_info');
      ...
      function bindAtchFile(data) {
        jQuery.each(data, function(i, obj) {
          $('.preview_file'+i).attr('id', obj.fileNo);
      ...
      function bindRegGoods(data) {
        ...
        jQuery.each(data.styleGoodsArr, function(i, obj) {
          var template  = '<tr id="tr_goods_' + obj["goodsNo"] + '" class="searchGoodsResult">'+
                  ...
                  '</span></label></td>'+
                  '<td>' + obj["rowNum"] + '</td>'+
                  '<td><img src="${_IMAGE_DOMAIN}' + obj["goodsImg"] + '"></td>'+
                  '<td>' + obj["goodsNm"] + '</td>'+
                  '<td>' + obj["goodsNo"] + '</td>'+
                  '<td>' + (!obj["brandNm"] ? '' : obj["brandNm"]) + '</td>'+
                  '<td>' + obj["sellerNm"] + '</td>'+
                  ...
                  '<td>' + (!obj["erpItmCode"] ? '' : obj["erpItmCode"]) + '</td>'+
                  '<td>' +
            ...
            <table summary="이표는 컬렉션 등록 표입니다. 구성은 상품분류,컬렉션 명,컬렉션 설명,컬렉션 대표미이미지, 내지 이미지, 컬렉셔 상품 설정,QR코드 입니다.">
                ...
                <td>
                  <span class="select">
                      <select name="goodsTypeCd">
                        <tags:option codeStr=":선택;01:안경테;02:선글라스;04:콘택트렌즈;03:안경렌즈;" value="${so.goodsTypeCd}"/>
                      </select>
                  </span>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span class="intxt imgup2"><input class="upload-name" type="text" disabled></span>
                  <label class="filebtn on">파일첨부
                    <input class="filebox" name="file10" type="file" accept="image/*">
                  </label>
                  <div class="upload_file preview_file10"></div>
                </td>
              </tr>
              <tr>
                <th>컬렉션 상품 설정</th>
              ...
              <tr>
                ...
                <td class="txtl qrcode">
                  ...
                  <br>
                  <span>
                    <input type="text" id="qrcodeWidth" value="100" style="width: 100px">
                    <img src="/admin/img/common/btn_close_popup02.png" alt="" class="icon_close ml5 mr5">
                    <input type="text" id="qrcodeHeight" value="100" style="width: 100px">
