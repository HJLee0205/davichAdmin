        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#tbody_id_bbsLettList a.tbl_link', function(e) {
                    ...
                    Dmall.FormUtil.submit('/admin/goods/board-goodsquestion-detail', param);
                });
                ...
                getBbsLettList : function() {
                    ...
                    Dmall.AjaxUtil.getJSON(url, param, function(result) {
                        var template = 
                            ...
                            '<td>{{rowNum}}</td>' +
                            '<td>{{goodsNm}}</td>' +
                            '<td class="txtl"><a href="#none" class="tbl_link">{{title}}</td>'+
                            '<td>{{memberNn}}</td>' +
                            ...
                            <table summary="이표는 게시판 리스트 검색 표 입니다. 구성은 검색어 입니다.">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <tags:checkboxs codeStr="Y:노출;N:비노출" name="expsYns" idPrefix="expsYn"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>답변 상태</th>
                                    <td>
                                        <span class="select">
                                            <label for="replyStatusYn">전체</label>
                    ...
                    <div class="line_box pb">
                        <div class="top_lay">
                            ...
                            <span class="search_txt">
                                총 <strong class="all" id="cnt_total"></strong>개의 상품 문의가 검색되었습니다.
                            </span>
                            </div>
                        </div>
                        <!-- tblh -->
