        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery('#viewBbsLettUpdate').on('click', function(e) {
                    ...
                    var param = {lettNo: "${so.lettNo}", bbsId : "${so.bbsId}", bbsNm : "${so.bbsNm}",titleUseYn:"${so.titleUseYn}",
                            noticeLettSetYn : "${so.noticeLettSetYn}", regrNo:regrNo, titleNo:titleNo}
                ...
                jQuery('#insertBbsComment').on('click', function(e) {
                    ...
                    if(Dmall.validate.isValid('form_id_bbsLett')) {
                        var url = '/admin/operation/board-comment-insert';
                ...
                jQuery(document).on('click', '#delBbsCmnt', function(e) {
                    ...
                    var url = '/admin/operation/board-comment-delete';
                    Dmall.AjaxUtil.getJSON(url, param, function(result) {
                        if(result.success){
                            $("#"+cmntSeq).remove();
                        }
                ...
                var url = '/admin/operation/board-comment-list';
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                    var text = '';
                ...
                <div class="tblw mt0">
                    <table summary="이표는 게시글 보기 표 입니다. 구성은 작성자, 작성일, 말머리, 공지글 설정, 제목, 내용 입니다.">
                        ...
                        <tbody>
                            ...
                            <tr>
                            	<th>URL</th>
                            	 <td colspan="3" id="bind_target_id_linkUrl" class="bind_target"></td>
                            </tr>
                            <tr>
                            	<th>연관검색어</th>
                            	<td colspan="3" id="bind_target_id_relSearchWord" class="bind_target"></td>
                            </tr>
                            <tr>
                                <th>내용</th>
                                <td colspan="3" id="contentArea" class="bind_target" style="height:100px;"></td>
                            </tr>
