    ...
    <t:putAttribute name="script">
        ...
        <script>
            $(document).ready(function() {
                ...
                // 이미지 삭제 버튼 클릭
                $(document).on('click', '.mg_upload_file .cancel', function(e) {
                    Dmall.EventUtil.stopAnchorAction(e);

                    $(e.target).parents('.mg_upload_file').remove();
                    $('input[name=file]').val('');
                })
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    ...
                                    <span class="fc_pr1 fs_pr1">
                                        &#183; 쉼표(,)로 띄어쓰기 없이 구분하여 등록해주세요. ex) 눈운동, 눈피로, 집중력
                                    </span>
                                </td>
                            </tr>
                            </tbody>
