...
<t:insertDefinition name="defaultLayout">
    <t:putAttribute name="title">홈 &gt; 프로모션 &gt; 이벤트 &gt; 이벤트 등록</t:putAttribute>
            ...
            var EventUtil = {
                ...
                save: function () {
                    ...
                    Dmall.LayerUtil.confirm('저장하시겠습니까?', function () {
                        ...
                        var url = '/admin/promotion/event-insert';
                    ...
                    <div class="tblw tblmany">
                        <table>
                            ...
                            <tr>
                                <th>이벤트명</th>
                                <td>
                                    <span class="intxt wid100p"><input type="text" name="eventNm" id="eventNm" value="" data-validation-engine="validate[required, maxSize[100]]"/></span>
                                </td>
                            </tr>
                            <tr>
                                <th>이벤트 설명</th>
                                <td>
                                    <span class="intxt wid100p"><input type="text" name="eventDscrt" id="eventDscrt" value="" data-validation-engine="validate[required, maxSize[300]]"/></span>
                                </td>
                            </tr>
                            <tr>
                                <th>이벤트 기간</th>
                            ...
                            <tr>
                                <th>당첨자 발표</th>
                                <td>
                                    <tags:calendarTimeOne from="wngFrom" idPrefix="wng" />
                                </td>
                            </tr>
                            <tr>
                                <th>이벤트 내용</th>
                            ...
                            <tr>
                                <th>이벤트 대표 이미지</th>
                                <td>
                                    <span class="intxt imgup2"><input id="file_route1" class="upload-name" type="text" readonly></span>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="desc_txt br2">· 쉼표 (,)로 구분하여 등록해주세요. ex) 안경, 안경테, 안경렌즈
                                </td>
                            </tr>
                            <tr>
                                <th>댓글사용여부</th>
                                <td>
                                    <label for="cmntUseY" class="radio mr20 on"><span class="ico_comm"><input type="radio" name="eventCmntUseYn" id="cmntUseY" value="Y" checked="checked" /></span> 사용 </label>
                                    <label for="cmntUseN" class="radio"><span class="ico_comm"><input type="radio" name="eventCmntUseYn" id="cmntUseN" value="N"/></span> 미사용</label>
                                </td>
                            </tr>
                            <tr>
                                <th>게시물노출여부</th>
                                <td>
                                    <label for="eventUseY" class="radio mr20 on"><span class="ico_comm"><input type="radio" name="eventUseYn" id="eventUseY" value="Y" checked="checked" /></span> 사용 </label>
                                    <label for="eventUseN" class="radio"><span class="ico_comm"><input type="radio" name="eventUseYn" id="eventUseN" value="N"/></span> 미사용</label>
                                </td>
                            </tr>
                            </tbody>
                        </table>
