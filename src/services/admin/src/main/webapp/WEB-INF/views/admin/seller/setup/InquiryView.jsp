        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                jQuery('#viewBbsLettList').on('click', function(e) {
                    ...
                    Dmall.FormUtil.submit('/admin/seller/setup/inquiry-list', param);
                });
...
//                 });
                ...
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                    ...
                    jQuery("#bind_target_id_memberNm").html(result.data.sellerNm+'(<span class="point_c3">'+result.data.sellerId+'</span>)');
