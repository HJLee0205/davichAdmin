                        ...
                        <tbody>
                            <tr>
                                ...
                                <td  colspan=3>
                                    ...
                                    <span class="select" id="span_refundClaimCd_template">
                                        ...
                                        <select name="refundClaimCd" id="refundClaimCd" style="display: none;">
                            ...
                            <tr id="bankInfo" >
                                ...
                                <span class="select " id="span_bankCd_template">
                                    <label for="bankCd" id="bankCd2"></label>
                                      <select name="bankCd" id="bankCd" style="display: none;">
                            ...
                            <tr>
                                ...
                                <span class="select" id="span_refundReasonCd_template">
                                    ...
                                    <select name="refundReasonCd" id="refundReasonCd" style="display: none;">
...
<%--                        <tr>--%>
<%--                            <td class="point_c5" id="estimateAmt">0</td>--%>
<%--                            <td><span class="intxt shot"><input type="text" name="modifyAmt" id="modifyAmt" /></span> 원</td>--%>
<%--                            <td><span class="intxt shot"><input type="text" name="refundAmt" id="refundAmt" /></span> 원</td>--%>
<%--                            <td style="text-align:left; padding-left:45px;">--%>
<%--                                마켓포인트 환불 : <span class="intxt shot"><input type="text" name="payReserveAmt" id="payReserveAmt" /></span>--%>
<%--                                <span class="point_c5"><b>최초 결제금액 <label id="tempReserveAmt">0</label>원</b></span>--%>
<%--                            </td>--%>
<%--                        </tr>--%>
<%--                        </tbody>--%>
...
<%--                                </span>--%>
<%--                                계좌번호--%>
<%--                                <span class="intxt long2  mr20"><input type="text" name="actNo" id="actNo" readonly/></span>--%>
<%--                                예금주--%>
<%--                                <span class="intxt"><input type="text" name="holderNm" id="holderNm" readonly/></span>--%>
<%--                                </td>--%>
<%--                            </tr>--%>
<%--                            --%>
<%--                            <tr>--%>
