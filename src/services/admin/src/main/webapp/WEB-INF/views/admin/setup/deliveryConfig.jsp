...
<t:insertDefinition name="defaultLayout">
    ...
    <t:putAttribute name="script">
        ...
        function fn_setDefault() {
         ...
         function fn_getInfo() {
             var url = '/admin/setup/delivery/delivery-config-info',
             param = ''; 
         ...
         function fn_save() {
             ...
             if(Dmall.validate.isValid('form_delivery_config')) {
                 var url = '/admin/setup/delivery/delivery-config-update',
         ...
         function fn_getSearchDeliveryList() {
             ...
             var url = '/admin/setup/delivery/delivery-area-list',
         ...
         function registZipData(data) {
             var url = '/admin/setup/delivery/delivery-area-insert',
             param = {
         ...
         function executeAreaEdit(obj) {
             ...
             $("#pop_btn_edit").off('click').on('click', function(e) {
                 ...
                 var url = '/admin/setup/delivery/delivery-area-update',
         ...
         function fn_apply_default() {
             Dmall.LayerUtil.confirm('기본 추가 배송비 설정을 적용하시면 기존 추가 배송비 정보가 삭제 됩니다. 기본 설정을 적용 하시겠습니까?', function() {
                 var url = '/admin/setup/delivery/default-delivery-update',
                     param = {};            
                 Dmall.AjaxUtil.getJSON(url, param, function(result) {
         ...
         function fn_delete() {
             Dmall.LayerUtil.confirm('<spring:message code="biz.common.confirmDelete"/>', function() {
                 var url = '/admin/setup/delivery/delivery-area-delete',
                     param = {},
                     key,
         ...
         function fn_all_delete() {
             Dmall.LayerUtil.confirm('<spring:message code="biz.common.confirmDelete"/>', function() {
             var url = '/admin/setup/delivery/alldelivery-area-delete',
                 param = {};           
                 Dmall.AjaxUtil.getJSON(url, param, function(result) {
                     jQuery('#hd_page').val(1);
                     fn_getSearchDeliveryList();
         ...
         function fn_getSearchHscdList() {
             var url = '/admin/setup/delivery/hscode-list',
         ...
         function setHscdDelete(data, obj, bindName, target, area, row) {
             obj.off("click").on('click', function(e) {
                 ...
                 if (!data || !data['hscdSeq']) {
                     ...
                     Dmall.LayerUtil.confirm('<spring:message code="biz.common.confirmDelete"/>', function() {
                     var url = '/admin/setup/delivery/hscode-delete',
         ...
         function setPopHscdEdit(data, obj, bindName, target, area, row) {
             obj.off("click").on('click', function(e) {
                 Dmall.EventUtil.stopAnchorAction(e);
                 var url = '/admin/setup/delivery/hscode-update',
                 $tr = obj.closest('tr'),
                 param = $tr.data("data"),
