        ...
        jQuery(document).ready(function() {
         ...
         // 검색일자 기본값 선택
            ...
            jQuery('#btn_excelDown').on('click', function(e) {
                jQuery('#form_excel_search').attr('action', '/admin/seller/order/invoice-temp-download');
...
//                param = jQuery('#form_excel_list').serialize(),
                ...
                ordQttArr = '', ordDtlStatusCdArr = '', goodsNoArr = '';
...
//                Dmall.FormUtil.submit(url, param);
    ...
    <t:putAttribute name="content">
        <div class="sec01_box">
        <div class="tlt_box">
            <h2 class="tlth2">송장 일괄 등록 </h2>
            <div class="btn_box right">
                <a href="#none" class="btn blue" id="btn_reg">등록</a>
            </div>
        </div>
        <!-- line_box -->
        <div class="line_box fri">
                    ...
                    <form:form id="form_excel_search">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn_exl" id="btn_excelDown">Excel download <span class="ico_comm">&nbsp;</span></button>
                            </td>
                        </tr>
                    </form:form>
            ...
            <ul class="desc_list">
                ...
                <c:set var="halfSize" value="${fn:length(courierCdList)/2}"/>
                    <div class="desc_box">
                        <ul>
                        <c:forEach var="listCd" items="${courierCdList}" varStatus="status" begin="0" end="${halfSize-1.5}">
                            <li><span>* ${listCd.dtlNm}</span>${listCd.dtlCd}</li>
                        </c:forEach>
                        </ul>
                        <ul>
                        <c:forEach var="listCd" items="${courierCdList}" varStatus="status" begin="${halfSize+1.5}">
                            <li><span>* ${listCd.dtlNm}</span>${listCd.dtlCd}</li>
                        </c:forEach>
                        </ul>
                    </div>
