...
<body class="bgw">
<div class="login_bg"><img src="/admin/img/common/new/login_bg.png" alt="로그인 배경화면"></div>
<!-- login_wrap -->
<div class="login_wrap">
	<h1 class="logo">스타일테일러 관리자 로그인</h1>
	<fieldset>
		...
		<form name="loginForm" id="loginForm" method="post" role="form" onsubmit="return false;">
			...
			<div class="login_entry">
				<span class="intxt">
					...
					<input name="loginId" id="loginId" type="text" style="ime-mode:disabled;" title="아이디">
				</span>
				<span class="intxt">
					<label for="password" class="hidden">비밀번호</label>
					<input class="mt10"  name="password" id="password" type="password" title="비밀번호" value="" autocomplete="false">
				</span>
