    ...
    <t:putAttribute name="script">
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('#btn_ordlist').on('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                var url = "/admin/seller/order/order-status";
                var data = {};
...
/*                        if (result == null || result.success != true) {
                           alert('<spring:message code="biz.exception.common.error"/>');
                       }else {
                           alert('<spring:message code="biz.common.insert"/>');
                       }
 */                           
                   });
               });
    ...
    <t:putAttribute name="content">
        <form:form id="form_ord_so" action="/admin/seller/order/order-status">
                        ...
                        <c:forEach var="orderGoodsVo" items="${orderGoodsVO}" varStatus="status">
                            <tr>
                                ...
                                <c:if test="${orderGoodsVo.addOptYn eq 'N' and orderGoodsVo.dlvrcCnt ne 0}">
                                    <td rowspan="${orderGoodsVo.dlvrcCnt}" id='${orderGoodsVo.areaAddDlvrc}' class="txtc">
