...
<t:insertDefinition name="defaultLayout">
	<t:putAttribute name="title">정산상세내역 > 업체</t:putAttribute>
		...
		<script>
			$(document).ready(function() {
				...
				$('#btn_id_search').on('click', function(e) {
					...
					$('#form_id_search').attr('action','/admin/seller/calc-manager-dtl-list');
				...
				$('#btn_download').on('click', function(e) {
					...
					$('#form_id_search').attr('action','/admin/seller/calc-dtl-download');
					$('#form_id_search').submit();
					$('#form_id_search').attr('action','/admin/seller/calc-manager-dtl-list');
				});
	...
	<t:putAttribute name="content">
		<div class="sec01_box">
			<div class="tlt_box">
				...
				<h2 class="tlth2">정산상세내역</h2>
			</div>
			<div class="search_box_wrap">
				<div class="search_box">
					<!-- search_tbl -->
					<form:form id="form_id_search" action="/admin/seller/calc-manager-dtl-list" commandName="sellerSO">
