...
<%@ taglib prefix="tags" tagdir="/WEB-INF/tags" %>
        ...
        function selectDeductList(){
            if(Dmall.validate.isValid('form_id_deduct_select')) {
                ...
                var url = '/admin/seller/calc/calc-deduct-list',
        ...
        function deductListAppend(result){
            if(result.length == 0){
                ...
                jQuery.each(result, function(idx, obj) {
					...
					if (obj.taxGbCd == "1") {
						$("input[name=taxGbCd" + (1 + idx) + "]").val("과세");
					} else if (obj.taxGbCd == "2") {
						$("input[name=taxGbCd" + (1 + idx) + "]").val("면세");
					}
                });
                $("#inputGbn").val("U");
            }
        ...
        $(document).on('click', '#btn_save', function(){
            var url = '/admin/seller/calc/calc-deduct-save',
            	param = {};
                    ...
                    <div class="tblh mt0">
                        <table summary="정산 상세 목록입니다.. ">
                            ...
                            <tbody id="deductListTbody">
                                <tr>
                                    <td rowspan="2">공제(+)</td>
                                    <td><span class="intxt"><input class="txtr comma" type="text" name="deductAmt1" value="" readonly/></span>
                                    </td>
                                    <td><span class="intxt long"><input type="text" name="deductDscrt1" value="" readonly/></span></td>
                                    <td>
                                		<input type="hidden" name="deductNo1" value="" />
                                		<input type="hidden" name="deductGbCd1" value="1" />
                                		<input type="text" name="taxGbCd1" value="" readonly/>
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td><span class="intxt"><input class="txtr comma" type="text" name="deductAmt2" value="" readonly/></span></td>
                                    <td><span class="intxt long"><input type="text" name="deductDscrt2" value="" readonly/></span></td>
                                    <td>
                                		<input type="hidden" name="deductNo2" value="" />
                                		<input type="hidden" name="deductGbCd2" value="1" />
                                		<input type="text" name="taxGbCd2" value="" readonly/>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="2">공제(-)</td>
                                    <td><span class="intxt"><input class="txtr comma" type="text" name="deductAmt3" value="" readonly/></span></td>
                                    <td><span class="intxt long"><input type="text" name="deductDscrt3" value="" readonly/></span></td>
                                    <td>
                                		<input type="hidden" name="deductNo3" value="" />
                                		<input type="hidden" name="deductGbCd3" value="2" />
                                		<input type="text" name="taxGbCd3" value="" readonly/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                		...
                                		<input type="text" name="taxGbCd4" value="" readonly/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
