...
//     if(Dmall.validate.isValid('form_email_charge')) {
        
//         var url = '/admin/operation/sms-charge-info',
//             param = $('#form_email_charge').serialize(), 
...
function chargeHistAppend(result){
    ...
    $('#emailChargeTbody').html(tbody);
    
    Dmall.GridUtil.appendPaging('form_email_charge', 'charge_paging', result, 'paging_id_manager', selectChargeHis);
}
...
<!-- layer_popup1 -->
<div id="emailCharge" class="layer_popup">
    <div class="pop_wrap size3">
        <!-- pop_tlt -->
        <div class="pop_tlt">
            <h2 class="tlth2">이메일 충전내역 확인하기</h2>
        ...
        <div class="pop_con">
            <div>
                <form action="" id="form_email_charge">
                <input type="hidden" name="memberNo" id="emailChargeMemNo" value="${memberManageSO.memberNo}" />
                <input type="hidden" name="page" id="charge_page" value="1" />
                <!-- tblh -->
                <div class="tblh mt0">
                    <table summary="이표는 이메일 충전내역 확인하기 표 입니다. 구성은 순번, 결제내용, 결제방법, 결제가격, 결제일 입니다.">
                        <caption>이메일 충전내역 확인하기</caption>
                        <colgroup>
                            <col width="8%">
                            <col width="23%">
                            <col width="23%">
