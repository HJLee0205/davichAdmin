...
public class GoodsQuestionController {
    ...
    public ModelAndView viewBbsLettList(BbsManageSO so) {
        String viewPage = "/admin/goods/goodsQuestion/GoodsQuestionList";
    ...
    public ModelAndView viewBbsLettDtl(BbsLettManageSO so) {
        String viewPage = "/admin/goods/goodsQuestion/GoodsQuestionReplyInsert";
    ...
    public @ResponseBody ResultModel<MemberManageVO> selectBbsLettDtl(MemberManageSO so) throws Exception {
        ResultModel<MemberManageVO> resultModel = memberManageService.viewMemInfo(so);
        return resultModel;
    }
}
