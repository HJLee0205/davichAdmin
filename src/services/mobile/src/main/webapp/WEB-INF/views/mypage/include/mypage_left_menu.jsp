    ...
    <ul class="mypage_side">
        ...
        <li>
            ...
            <ul class="mypage_side_s">
                ...
                <li><a href="/front/member/point" <c:if test="${leftMenu eq 'my_point'}" >class="selected"</c:if>>- 나의 포인트</a></li>
        ...
        <li>
            ...
            <ul class="mypage_side_s">
                ...
                <li><a href="" <c:if test="${leftMenu eq 'goods_sms'}" >class="selected"</c:if>>- 재입고알림</a></li>
            </ul>
        </li>
        <li>
            <a href="">나의 활동</a>
        ...
        <li>
            ...
            <ul class="mypage_side_s">
                ...
                <li><a href="/front/member/information-update-form" <c:if test="${leftMenu eq 'update_member'}" >class="selected"</c:if>>- 개인정보 수정</a></li>
                <li><a href="/front/member/member-leave-form" <c:if test="${leftMenu eq 'delete_member'}" >class="selected"</c:if>>- 회원탈퇴</a></li>
            </ul>
        </li>
    </ul>
