...
<t:insertDefinition name="davichLayout">
	...
	<t:putAttribute name="script">
                ...
                Dmall.LayerUtil.confirm("등록 하시겠습니까?",
                    function() {
                        ...
                        if(Dmall.validate.isValid('form_id_insert')) {
                            ...
                            var url = '/front/community/letter-insert';
	    ...
	    function changeCaptcha() {
	        $('#captcha').html('<img src="'+window.location.origin+'/front/community/capchacode-create?rand='+ Math.random() + '" />');
	    }
                        ...
                        <table class="tFree_Insert">
                            ...
                            <c:if test="${bbsInfo.data.bbsKindCd eq 1}">
                                ...
                                <tr>
                                    <th>제목</th>
                                    <td>
                                        <input type="text" name="title" id="free_board_title">
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <c:if test="${so.grpNo eq null || so.grpNo == ''}">
                                ...
                                <tr id ="fileUploadSet1">
                                    ...
                                    <td>
                                        ...
                                        <div class="file_up">
                                            ...
                                            <input type="file" name="imageFile" id="input_id_image" accept="image/*">
                                        </div>
                                ...
                                <tr id ="fileUploadSet2">
                                    ...
                                    <td>
                                        ...
                                        <!--input type="text" id="filename02" class="floatL" readonly="readonly">
                                        <div class="file_up">
                                            <span id = "fileSetList">
												<span id="fileSpan1" style="visibility: visible">
													<button type="button" class="btn_fileup" value="Search files">file</button>
													<input type="file" name="files1" id="input_id_files1" >
												</span>
                                            </span>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="free_pw_check">                                            
											<input type="radio" class="order_radio" id="freeboard_password_check1" name="freeboard_password_check"  value="N" checked onclick="javascript:setSectYn();">
											<label for="freeboard_password_check1"><span></span>일반글</label>	                                            
											<input type="radio" class="order_radio" id="freeboard_password_check2" name="freeboard_password_check" value="Y" onclick="javascript:setSectYn();">
											<label for="freeboard_password_check2"><span></span>비밀글</label>
                                        </div>
                                    </td>
                                </tr>
                                <tr id="tr_pw">
