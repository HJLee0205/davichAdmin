...
<t:insertDefinition name="davichLayout">
	...
	$(".btn_recomm_save_new").click(function(){
        ...
        Dmall.LayerUtil.confirm("결과를 저장하시겠습니까?", function(){
        	...
        	$.ajax({
    	 		...
    	 		complete: function(){				
    	 			document.location.href='${_MOBILE_PATH}/front/vision2/my-vision-check-c';
    	 		}
    	 	});	
        });
    });	
	...
	<div id="middle_area">
		...
		<form:form id="form_vision_check" name="form_vision_check" method="post">
			...
			<input type="hidden" name="returnUrl" value="${_MOBILE_PATH}/front/vision2/vision-check-cr"/>
        </form:form>
		<div class="cont_body">
			...
			<c:forEach var="result" items="${visionGunList}" varStatus="status">
				<li>
					<p class="img">
						...
						<img src="${_IMAGE_DOMAIN}/image/image-view?type=VISION&path=${result.filePath}&id1=${result.fileNm}" alt="${result.gunNm}" onerror="this.src='../img/promotion/promotion_ing01.jpg'" >
						</c:if>
					</p>
					<div class="info">
						<p class="tit">	
