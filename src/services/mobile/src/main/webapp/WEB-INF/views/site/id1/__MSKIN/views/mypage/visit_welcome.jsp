...
<t:insertDefinition name="davichLayout">
    	...
    	$('#visit_book').on('click',function(){
            ...
            if(loginYn == 'true') {
                ...
                Dmall.LayerUtil.confirm("로그인이 필요한 서비스입니다.<br>지금 로그인 하시겠습니까?",
                    ...
                    function() {
                    	Dmall.FormUtil.submit('${_MOBILE_PATH}/front/login/member-login',param);
                        //location.href= "${_MOBILE_PATH}/front/login/member-login?returnUrl=${_MOBILE_PATH}/front/visit/visit-book"
                    },'');
            }
        });
    ...
    <form name="visitForm" id="visitForm">
		...
		<input type="hidden" id="storeNm" name="storeNm" value="${param.storeNm}"/>
		<input type="hidden" id="storeCode" name="storeCode" value="${param.storeCode}"/>
	...
	<div id="middle_area">
		...
		<div class="cont_body visit">
			<div class="visit_main_box">
				<p class="text">
					<%--<img src="${_SKIN_IMG_PATH}/mypage/visit_img02.jpg" alt="다비치안경만의 차별화된 매장 서비스를 경험해보세요">--%>

					<img src="${_SKIN_IMG_PATH}/visit/visit_img03_top.jpg" alt="다비치안경만의 차별화된 매장 서비스를 경험해보세요">
					<a href="javascript:;" id="csnDtl">
						<img src="${_SKIN_IMG_PATH}/visit/visit_img03_btn.jpg" alt="상세보기">
					</a>
					<img src="${_SKIN_IMG_PATH}/visit/visit_img03.jpg" alt="눈검사, 시착서비스, 피팅서비스, 매장픽업 서비스">
				</p>
			</div>
			...
			<div class="visit_non_member" style="display:none;">
				...
				<div class="privacy_agree">
					1. 수집&middot;이용 목적 : 비회원 고객 매장방문예약 확인 취소에
					   <p class="marginL10">대한 이용 기록 보관</p>
	...
	<!-- popup popup_eye_text -->
	<div class="popup popup_eye_test" style="display:none;">
		<div id="popup_content">
			<div class="scroll">
				<img src="${_SKIN_IMG_PATH}/visit/visit_eye_test.jpg" alt="눈검사 제품 컨설팅 서비스 안내">
			</div>
		</div>
