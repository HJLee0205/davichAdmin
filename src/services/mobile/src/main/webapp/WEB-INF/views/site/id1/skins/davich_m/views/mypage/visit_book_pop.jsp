...
<div class="popup">
	<div class="inner cancel" style="width:100%; height:400px;">
		<div class="popup_head">
			<h1 class="tit"><span id="id_storeNm">방문예약 목록</span></h1>
			<button type="button" class="btn_close_popup">창닫기</button>
		</div>
		<div class="popup_body" style="width:100%; height:250px; overflow:auto;">
			<table class="tProduct_Board"  style="width:95%;">
				<colgroup>
					<col style="width:10%">
					<col style="width:30%">
					<col style="width:30%">
