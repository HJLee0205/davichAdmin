...
<%@ page import="net.danvi.dmall.core.service.payment.PaycoUtil" %>
...
<% 
    ...
    returnUrl                   = domainName + "/samplePaycoReturn.do";            //[선택]주문완료 후 Redirect 되는 Url
    returnUrlParam              = "{\"cart_no\":\"20151234567\"}";           //[선택]주문완료 후 Redirect 되는 URL과 함께 전달되어야 하는 파라미터(Json 형태의 String)
    nonBankbookDepositInformUrl = domainName + "/samplePaycoWithoutBankbook.do";  //[선택]무통장입금완료통보 URL
    ...
    extraData.put("payExpiryYmdt", "20160710180000");                           //[선택]해당 주문예약건 만료 처리 일시 (해당 일시 이후에는 결제 불가)(14자리로 맞춰주세요)
    extraData.put("virtualAccountExpiryYmd", "20160712150000");                 //[선택]가상계좌만료일시(14자리로 맞춰주세요)
