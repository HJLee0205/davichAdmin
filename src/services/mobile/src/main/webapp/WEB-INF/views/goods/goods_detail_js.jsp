        ...
        $('select.select_option.goods_addOption').on('change',function(){
            ...
            if($(this).find(':selected').val() != '') {
                ...
                if(addLayer) {
                    ...
                    optObj += '            <button type="button" class="btn_up" onclick="jsUpdateLayerQtt(\'add_opt\','+k+',\'up\')"><span class="icon_plus"></span></button>';
                    optObj += '            <button type="button" class="btn_down" onclick="jsUpdateLayerQtt(\'add_opt\','+k+',\'down\')"><span class="icon_minus"></span></button>';
                    ...
                    optObj += '        <span class="product_option_price">';
                    optObj += '            <em class="addOptSumAmtText"></em>원';
                ...
                if(result.resultList.length > 0) {
                    if(result.resultList.length == 1) {
                        ...
                        for(var i=0; i < result.resultList.length; i++) {
                            ...
                            couponList += '                        <td class="text6">'+couponPeriodInfo+'</td>';
                        ...
                        couponLayerPop += '                    <col style="width:40%">';
