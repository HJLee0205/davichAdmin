        ...
        <script>
            jQuery(document).ready(function() {
                ...
                jQuery('button.btn_error_go_main').on('click', function() {
                	ocation.href = '/front/member/terms-apply';
                });
            });
...
다시 한 번 확인해주시기 바랍니다.<br/> -->
		...
		<div class="error_btn_area">
			<button type="button" class="btn_error_go">메인페이지로 돌아가기</button>
			<button type="button" class="btn_error_go_main">다시 요청하기</button>
		</div>
