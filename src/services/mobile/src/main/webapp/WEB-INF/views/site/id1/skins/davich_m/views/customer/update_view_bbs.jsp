...
<t:insertDefinition name="davichLayout">
	<t:putAttribute name="title">다비치마켓 :: 게시글 수정</t:putAttribute>
	...
	<t:putAttribute name="script">
	    ...
	    $(document).ready(function(){
                ...
                Dmall.LayerUtil.confirm("수정 하시겠습니까?",
                    function() {
                        ...
                        if(Dmall.validate.isValid('form_id_update')) {
                            ...
                            var url = '${_MOBILE_PATH}/front/customer/letter-update';
            ...
            jQuery(document).on('change',"input[type=file]", function(e) {
                ...
                if(fileLength+totalFileLength>5){
        ...
        function delOldFileNm(fileNo){
            var url = '${_MOBILE_PATH}/front/customer/attach-file-delete';
                            ...
                            <c:if test="${resultModel.data.grpNo eq resultModel.data.lettNo}">
                                ...
                                <tr>
                                    <td class="insert" colspan="2">
                                        <div id="edit">
                                            <textarea style="width:97.5%;height:128px" name="content" id="free_insert_area" class="blind">${resultModel.data.content}</textarea>
                                        </div>
                                    </td>
                                </tr>
                            <c:if test="${resultModel.data.grpNo eq resultModel.data.lettNo}">
                                ...
                                <tr id ="fileUploadSet1">
                                    ...
                                    <td>
                                        ...
                                        <c:forEach var="fileList" items="${resultModel.data.atchFileArr}" varStatus="status">
                                            ...
                                            <div class="bbs_g_thum" id="imgFile_${fileList.fileNo}"><img src="${_IMAGE_DOMAIN}/image/image-view?type=BBS&path=${fileList.filePath}&id1=${fileList.fileNm}" alt="리스트이미지" width="65px" height="65px"><button type="button" class="reply_del" onclick="delOldImgFileNm('${fileList.fileNo}')" ><img src='../img/product/btn_reply_del.gif' alt=파일삭제'></button></div>
                                            </c:if>
                                        </c:forEach>
                                    </td>
                                </tr>
