                                ...
                                <tr id ="fileUploadSet1">
                                    ...
                                    <td>
                                        ...
                                        <c:forEach var="fileList" items="${resultModel.data.atchFileArr}" varStatus="status">
                                            ...
                                            <div class="bbs_g_thum"><img src="${_IMAGE_DOMAIN}/image/image-view?type=BBS&path=${fileList.filePath}&id1=${fileList.fileNm}" alt="리스트이미지" width="65px" height="65px"><button class="reply_del" onclick="delOldImgFileNm('${fileList.fileNo}')" ><img src='../img/product/btn_reply_del.gif' alt=파일삭제'></button></div>
                                            </c:if>
                                        </c:forEach>
                                    </td>
                                </tr>
