...
<t:insertDefinition name="davichLayout">
    <t:putAttribute name="title">다비치마켓 :: 텐션 사전예약</t:putAttribute>
    ...
    <t:putAttribute name="content">
		...
		<div class="cont_body event_tensean_area">
			...
			<input type="hidden" name="teanseonMiniYn" id="teanseonMiniYn" value="Y">
			<input type="hidden" name="ch" id="ch" value="${so.ch eq null?"TSE02-00":so.ch}">
    		...
    		<iframe width="100%" height="315" src="https://www.youtube.com/embed/EfSryPzF58s" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
			</div>
			<div class="movie_outline">
			<iframe width="100%" height="315" src="https://www.youtube.com/embed/ZjMEgw8VrK0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class="movie_outline">
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/_V09SCJtVXg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
            </div>
    		<img src="${_SKIN_IMG_PATH}/event/main_01.jpg" alt="텐션 하프벡 사전 예약 이벤트">
        	<img src="${_SKIN_IMG_PATH}/event/main_02.jpg" alt="텐션 하프벡 사전 예약 이벤트">
			<%--<img src="${_SKIN_IMG_PATH}/event/event_tensean01.jpg" alt="텐션 베스트 제품 미니팩 출시 사전 예약 이벤트">--%>
			<%--<img src="${_SKIN_IMG_PATH}/event/event_tensean02.jpg" alt="텐션 프리즘벨벳 브라운">
			<a href="${_MOBILE_PATH}/front/goods/goods-detail?goodsNo=G2008041558_7972">
				<img src="${_SKIN_IMG_PATH}/event/event_tensean03.jpg" alt="텐션 프리즘벨벳 브라운 제품 보러가기">
			</a>
			<img src="${_SKIN_IMG_PATH}/event/event_tensean04.jpg" alt="믿고쓰는 마마무 추천템 다 빛이나 CF를 확인해보세요">
			<a href="${_MOBILE_PATH}/front/goods/goods-detail?goodsNo=G2008041551_7970">
				<img src="${_SKIN_IMG_PATH}/event/event_tensean05.jpg" alt="텐션 프리즘벨벳 그레이 제품 보러가기">
			</a>
			<img src="${_SKIN_IMG_PATH}/event/event_tensean06.jpg" alt="믿고쓰는 마마무 추천템 다 빛이나 CF를 확인해보세요">--%>
			...
			<a href="javascript:;" id="btn_non_visit">
				<img src="${_SKIN_IMG_PATH}/event/event_tensean07.jpg"  alt="텐션 베스트 제품 미니팩 사전 예약하기">
			</a>
			</form>
