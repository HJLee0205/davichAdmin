        ...
        $(document).ready(function(){
            ...
            $('.btn_free_comment').on('click', function(e) {
                ...
                if(Dmall.validate.isValid('form_id_cmn')) {
                    ...
                    var url = '/front/community/lettter-comment-insert';
            ...
            $('.reply_del').on('click', function(e) {
                ...
                if(Dmall.validate.isValid('form_id_cmn')) {
                    Dmall.LayerUtil.confirm("삭제하시겠습니까?",
                            function() {
                                var url = '/front/community/letter-comment-delete';
            ...
            $('.btn_free_reply').on('click', function() {
                ...
                Dmall.FormUtil.submit('/front/community/letter-insert-form', param);
            });
                        ...
                        if(result){
                            switch(actionNm) {
                                ...
                                case 'update' :
                                    ...
                                    Dmall.FormUtil.submit('/front/community/letter-update-form', param);
                                    break;
                                case 'delete' :
                                    Dmall.LayerUtil.confirm("삭제 하시겠습니까?",
                                        function() {
                                            var url = '/front/community/letter-delete';
                                            var param = {bbsId:"${so.bbsId}", lettNo:"${so.lettNo}"};
                    ...
                    <table class="tFree_View">
                        ...
                        <!-- <c:if test="${bbsInfo.data.bbsKindCd eq 1}">    
                            ...
                            <tr>
								...
								<c:if test="${bbsInfo.data.bbsKindCd eq 1}">    
									<c:if test="${bbsInfo.data.titleUseYn eq 'Y'}">
										<span class="label_keyword">${resultModel.data.titleNm}</span>
									</c:if>
								</c:if>
								${resultModel.data.title}</th>
                            </tr>
                            <tr>
                                <td colspan="2">${resultModel.data.regrNm} <fmt:formatDate pattern="yyyy-MM-dd" value="${resultModel.data.regDttm}" /></td>
                                <!-- <th>게시일</th>
                                <td><fmt:formatDate pattern="yyyy-MM-dd" value="${resultModel.data.regDttm}" /></td> -->
                            </tr>
                            <tr>
                                <td class="view bbs_file" colspan="2">
