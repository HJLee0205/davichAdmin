...
<t:insertDefinition name="davichLayout">
	...
	$(".btn_view_recomm").click(function(){                	
        ...
        if($('#step1Cd').val() == '01'){
        	Dmall.FormUtil.submit('${_MOBILE_PATH}/front/vision/vision-check2-s3', param);
        }else{
        	Dmall.FormUtil.submit('${_MOBILE_PATH}/front/vision/vision-check2-s2', param);	
        }
					...
					<ul class="check_list">
						<c:forEach var="result" items="${step1List}" varStatus="status">
							<li onclick="fn_select_step1('${result.step1Cd}', ${status.count-1});">
								...
								<span>${result.step1Nm}<i>check</i></span>
							</li>
						</c:forEach>
					</ul>
