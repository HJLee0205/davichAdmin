...
var PaycoUtil = {
    domainName:location.protocol + '//' + location.host + '/m/front/order'
    , logYn:"Y"
    ...
    , callPaycoUrl:function(){
        var Params = "customerOrderNumber=" + "${ordNo}"
            ...
            + "&cancelMobileUrl=" + PaycoUtil.domainName + '/payco-cancel'
            + "&returnUrl=" + PaycoUtil.domainName + '/payco-result';

        // localhost 로 테스트 시 크로스 도메인 문제로 발생하는 오류
        //$.support.cors = true;
        $.ajax({
            type: "POST",
            url: PaycoUtil.domainName + "/payco-reserve",
    ...
    , paycoOrder:function(orderUrl) { // 결체창 팝업
        ...
        openNewWindow.location.href = orderUrl;
