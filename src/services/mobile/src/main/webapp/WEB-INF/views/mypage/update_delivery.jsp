            ...
            <table class="tProduct_Insert" style="margin-top:5px">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="text" style="width:232px;" name="gbNm" value="${deliveryData.gbNm}"></td>
                    </tr>
                    <tr>
                        <th class="order_tit"><em>*</em>이름</th>
                        <td><input type="text" style="width:232px;" name="adrsNm" value="${deliveryData.adrsNm}"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="mypage_check">
                                <label>
                                    <input type="checkbox" name="defaultYn_check" <c:if test="${deliveryData.defaultYn eq 'Y'}" >checked</c:if>/>
                                    <span></span>
                                    기본 배송지로 설정
                                </label>
                            </div>
