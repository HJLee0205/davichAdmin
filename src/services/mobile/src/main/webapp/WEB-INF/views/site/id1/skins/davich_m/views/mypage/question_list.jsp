...
/*         //검색시 구분값 셋팅
    ...
    function goodsDetail(goodsNo){
        location.href = "${_MOBILE_PATH}/front/goods/goods-detail?goodsNo="+goodsNo;
    }
    ...
    <div id="">	
		...
		<div class="my_qna_top floatC">
			<ul class="my_shopping_info">
				<li>다비치마켓 상품에 대해 문의하신 내역입니다</li>
			</ul>
		</div>

		<!-- <div class="product_qna_top">
			<div class="qna_warning">
				다비치마켓 상품에 대해 문의하신 내역입니다
			</div>
		</div> -->
		...
		<div class="product_qna_area">			
			...
			<ul class="qna_list">
				<c:choose>
												...
												<div class="qna_question_text">
													...
													<c:if test="${resultModel.replyStatusYn != 'Y'}" >
		                                                <div class="view_btn_area">
                                                            <button type="button" class="btn_modify" style="width: 80px;float: left;" onclick="javascript:goodsDetail('${resultModel.goodsNo}'); return false;">상품상세정보</button>
													...
													<c:if test="${resultModel.replyStatusYn eq 'Y'}" >
														<div class="view_btn_area">
															<button type="button" class="btn_modify" style="width: 80px;" onclick="javascript:goodsDetail('${resultModel.goodsNo}'); return false;">상품상세정보</button>
														</div>
													</c:if>
												</div>
												<!--// 질문 -->
                  ...
                  <c:otherwise>
                  	<li><ul class="qna_view"><li class="none_data">등록된 상품문의 내역이 없습니다.</li></ul></li>
                  </c:otherwise>
               </c:choose>	
			</ul>
			<!--- 페이징 --->
