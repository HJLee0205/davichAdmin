...
<t:insertDefinition name="davichLayout">
    ...
    <t:putAttribute name="script">
               ...
               $('#btn_visit').on('click',function(){
				    ...
				    if (loginYn) {
                        ...
                        /*Dmall.LayerUtil.confirm("로그인이 필요한 서비스입니다.<br>지금 로그인 하시겠습니까?",
                            ...
                            function () {
                                location.href = "${_MOBILE_PATH}/front/login/member-login?returnUrl=/front/event/chuseok-event?ch=${so.ch}"
                            }, '');*/
                    }
		...
		function scrollController() {
			...
			currentScrollTop = $(window).scrollTop();
			if (ETBottom < 468) {
				if ($('.btn_scroll_move').css('bottom', 56)) {
		...
		<div class="cont_body event_tensean_area">
			...
			<div class="cont_body event_fall_area">
				...
				<div class="event_float_area">
					...
					<a href="${_MOBILE_PATH}/front/promotion/promotion-list">
