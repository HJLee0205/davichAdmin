...
<script type="text/javascript">
    ...
    function mobRfShop(){
        ...
        if (document.getElementById("btn_go_cart")){
            document.getElementById("btn_go_cart").onmouseup = function() {
                sh.sendCart();
            }
        }
        // 찜,Wish 버튼 클릭 시 호출 메소드(사용하지 않는 경우 삭제)
        if (document.getElementById("btn_favorite_go")){
            document.getElementById("btn_favorite_go").onmouseup = function() {
                sh.sendWish();
            }
        }
    }
            ...
            if (optAdd) {
                ...
                if (itemInfo != '') {
                    ...
                    if(addLayer) {
                        ...
                        optObj += '     <input type="hidden" name="itemSumSalePriceArr" class="itemSumSalePriceArr" value="'+salePrice+'">';
                ...
                if(preGoodsYn == 'Y' || goodsNo =='G2104082005_8744' || goodsNo=='G2103261158_8727'){
                    ...
                    Dmall.AjaxUtil.getJSON(url, param, function(result) {
                        if(!result.success){
                            ...
                            $('#goods_form').attr('action','/m/front/visit/visit-book');
                            $('#goods_form').attr('method','post');
                            $('#goods_form').submit();
                        }
                    });
