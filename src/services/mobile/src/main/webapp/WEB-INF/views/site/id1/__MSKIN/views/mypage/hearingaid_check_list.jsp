				...
				<c:choose>
					<c:when test="${empty hearingaidCheckList}">
						<div class="lens_recomm result">
							...
							<button type="button" class="btn_lens_show" onclick="document.location.href='${_MOBILE_PATH}/front/hearingaid/hearingaid-check';">지금 추천받기<i></i></button>
						</div>
					</c:when>
					<c:otherwise>					
						<div class="lens_recomm result">
							${topHearingaidCheckVO.resultAll}
							<button type="button" class="btn_lens_show" onclick="document.location.href='${_MOBILE_PATH}/front/hearingaid/hearingaid-check';">보청기추천 다시받기<i></i></button>
