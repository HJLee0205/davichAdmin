...
<t:insertDefinition name="davichLayout">
	...
	$(".btn_view_recomm2").click(function(){
		document.location.href="${_MOBILE_PATH}/front/vision/vision-check2";
	});
	...
	$(".btn_view_recomm").click(function(){                	
        ...
        if($("#visionGb").val() == 'G'){
			Dmall.FormUtil.submit('${_MOBILE_PATH}/front/vision/recommend-lens2', param);
        }else if($("#visionGb").val() == 'C'){
        	Dmall.FormUtil.submit('${_MOBILE_PATH}/front/vision/vision-check2-s5', param);
		}
					...
					<ul class="check_list">
						<c:forEach var="result" items="${step4List}" varStatus="status">
							<li onclick="fn_select_step4(this);" data-step4Cd="${result.step4Cd}" data-checkNo="${result.checkNos}">
								...
								<span>${result.step4Nm}<i>check</i></span>
							</li>
						</c:forEach>
					</ul>
