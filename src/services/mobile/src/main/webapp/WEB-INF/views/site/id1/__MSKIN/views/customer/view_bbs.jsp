        ...
        $(document).ready(function(){
            ...
            $('.btn_free_comment').on('click', function(e) {
                ...
                if(Dmall.validate.isValid('form_id_cmn')) {
                    ...
                    var url = '${_MOBILE_PATH}/front/customer/lettter-comment-insert';
            ...
            $('.reply_del').on('click', function(e) {
                ...
                if(Dmall.validate.isValid('form_id_cmn')) {
                    Dmall.LayerUtil.confirm("삭제하시겠습니까?",
                            function() {
                                var url = '${_MOBILE_PATH}/front/customer/letter-comment-delete';
            ...
            $('.btn_free_reply').on('click', function() {
                ...
                if(writeReplyUseYn == 'Y') {
	                ...
	                Dmall.FormUtil.submit('${_MOBILE_PATH}/front/customer/letter-insert-form', param);
            } else {
            ...
            $('.btn_free_list').on('click', function() {
                location.href = '${_MOBILE_PATH}/front/customer/board-list?bbsId=${so.bbsId}';
            });
                        ...
                        if(result){
                            switch(actionNm) {
                                ...
                                case 'update' :
                                    ...
                                    Dmall.FormUtil.submit('${_MOBILE_PATH}/front/customer/letter-update-form', param);
                                    break;
                                case 'delete' :
                                    Dmall.LayerUtil.confirm("삭제 하시겠습니까?",
                                        function() {
                                            var url = '${_MOBILE_PATH}/front/customer/letter-delete';
                                            var param = {bbsId:"${so.bbsId}", lettNo:"${so.lettNo}"};
            ...
            <div class="community">
                ...
                <div class="community_content">
                        ...
                        <tbody>
                            <tr>
                                <th colspan="2" class="bbs_title">
									...
									&nbsp; ( <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${resultModel.data.regDttm}" /> )</span>
								</th>
                            </tr>
                            <!-- <tr>
                                <th>게시일</th>
                            ...
                            <tr>
                                <td colspan="2" class="view bbs_file">
                                                ...
                                                <c:forEach var="commentList" items="${commentList.resultList}" varStatus="status">
                                                    <div class="free_comment_view">
                                                        ...
                                                        <div class="free_comment_info">
                                                            ...
                                                            <button type="button" class="reply_del" cmntSeq="${commentList.cmntSeq}"></button>
                                                            </c:if>
                                                        </div> 
                                                    </div>
                                                    <!---// comment 보기01 --->
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${preBbs.data.sectYn eq 'Y'}">
                                            <c:set var="preTitle" value="<img src='../img/mypage/icon_free_lock.png'alt='비밀글' style='vertical-align:middle'> ${preBbs.data.title}"/>
                                        </c:when>
                                        <c:otherwise>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${nextBbs.data.sectYn eq 'Y'}">
                                            <c:set var="nextTitle" value="<img src='../img/mypage/icon_free_lock.png'alt='비밀글' style='vertical-align:middle'> ${nextBbs.data.title}"/>
                                        </c:when>
                                        <c:otherwise>
                    ...
                    <!-- <div class="btn_free_area floatC">
                        ...
                        <div class="floatR">
                            <c:if test="${bbsInfo.data.writeReplyUseYn eq 'Y'}">
                                <c:if test="${bbsInfo.data.bbsKindCd eq 1}">
                                    <c:if test="${resultModel.data.noticeYn ne 'Y' }">
