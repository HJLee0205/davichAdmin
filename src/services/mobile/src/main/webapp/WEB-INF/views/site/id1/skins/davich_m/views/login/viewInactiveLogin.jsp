...
<t:insertDefinition name="davichLayout">
            ...
            function successIdentity(){
                ...
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                    if(result.success) {
                        ...
                        //window.location.href = '${_MOBILE_PATH}/front/login/member-login';
    ...
    <t:putAttribute name="content">
        ...
        <!--- contents --->
        <%--<div class="contents fixwid" style="width:100%">--%>
        <div class="cont_body" id="loginLayer">
            <div class="inactivity_login_box">
                ...
                <div class="join_check_all">
					...
					<label for="rule_agree"><span></span>회원 계정 휴면 해제 동의</label>
                </div>
				...
				<button type="button" class="btn_go_inactivity02 btn_popup_login"><i></i>휴면 해지하기</button>

				<div class="inactivity_text02">
					다비치마켓은 회원님의 개인정보보호를 위하여 장기간 로그인 하지 않은 계정을
