...
<script>
    ...
    <div class="popup_my_shipping_address">
        <div class="popup_header">
            ...
            <button type="button" id="closeDeliveryList" class="btn_close_popup"><img src="/front/img/common/btn_close_popup.png" alt="팝업창닫기"></button>
        </div>
        <div class="popup_content">
			<ul class="popup_comment">
                <li>원하시는 배송지의 선택버튼을 클릭하시면, 주문서에 적용됩니다.</li>
                <!-- <li>나의 배송 주소록에는 최대 5개의 주소록이 등록됩니다.</li> -->
            </ul>
            <div class="popup_address_scroll2">
				...
				<c:choose>
					<c:when test="${resultListModel.resultList ne null}">
						<c:forEach var="deliveryList" items="${resultListModel.resultList}" varStatus="status">
							<div class="delivery_table_wrap">
							<table class="tProduct_Board delivery_table">
								<caption>
								...
								<tr>
									<th colspan="2">
										<em>${deliveryList.adrsNm} (배송지명 : ${deliveryList.gbNm})</em>
										<button type="button" class="mybtn"
															data-mobile="${su.phoneNumber(deliveryList.mobile)}"
															data-tel="${su.phoneNumber(deliveryList.tel)}"
															data-membergbcd="${deliveryList.memberGbCd}"
															data-adrsNm="${deliveryList.adrsNm}"
															...
															data-frgaddrdtl2="${deliveryList.frgAddrDtl2}">선택
										</button>
		                            </th>
								</tr>
								<tr>
