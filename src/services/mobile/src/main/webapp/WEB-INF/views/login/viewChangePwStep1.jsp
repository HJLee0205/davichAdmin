		...
		<script>
			jQuery(document).ready(function() {
				jQuery('#btn_id_pwchange').on('click', function () {
					window.location.href = HTTPS_SERVER_URL + '${_MOBILE_PATH}/front/login/change-password-step2';
				});
				jQuery('#btn_id_next').on('click', function () {
					window.location.href = '${_MOBILE_PATH}/front/login/password-nextchange-update';
				});
			});
		</script>
	</t:putAttribute>
