...
<t:insertDefinition name="davichLayout">
	<t:putAttribute name="title">매장찾기</t:putAttribute>
...
<!-- 	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=7908f301e3f1e3be1d8afbeee039b908&libraries=services"></script>	 -->
	    ...
	    function makeClickListener(map, marker, infowindow,item) {
	        return function() {
	             ...
	             var info = '<div class="popup_map_info">' +
	      		   ...
	      		   ' <h1 class="popup_tit">' + item.storeNm +'</h1>' + 
		                    ...
		                    jQuery.each(result.strList, function(idx, obj) {
		                    	...
		                    	var telNo = obj.telNo;
		                         address.push({"address":addr,"storeNo":strCode,"storeNm":strName, "telNo":telNo});
		                  		 str += '<li><a href="javascript:void(0);" onClick="focusMap(\''+ addr + '\')" class="pop_view_shop02">' + obj.strName + '<span class="phone_no">' + obj.telNo + '</span></a></li>';
		                    });
		...
		function searchGugun(sVal, sValNm) {
		    ...
		    Dmall.AjaxUtil.getJSON(url, param, function(result) {
	            ...
	            sortData.sort(function(a,b){
          		 ...
          		 str += '<ul class="sub_name">';
		        // 취득결과 셋팅
		        jQuery.each(sortData, function(idx, obj) {
		           		 str += '<li><a href="javascript:void(0);" class="pop_view_shop" onClick="storeDtlPopup(\''+ obj.strCode + '\')" >' + obj.strName + '</a></li>';
		        });
          		 str += '</ul>';
	...
	<div id="middle_area">
		...
		<ul class="my_tabs">
			<li class="active" rel="tab01" style="width:50%">지역별로 찾기</li>
			<li rel="tab02" style="width:50%">가까운 매장찾기</li>
		</ul>
		<div class="my_tabs_content" id="tab01" style="display: block;">
			<ul class="map_name">
		...
		<div class="my_tabs_content" id="tab02" style="display:block;">
			<div class="near_shop">
				<div class="top_area">
				</div>
