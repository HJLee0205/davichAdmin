                                    ...
                                    <c:forEach var="bbsList" items="${resultListModel.resultList}" varStatus="status">
                                        ...
                                        <c:choose>
                                            <c:when test="${bbsList.sectYn eq 'Y'}">
                                                <c:set var="title" value="<img src='../img/mypage/icon_lock.gif' alt='비밀글' style='vertical-align:middle'>  ${bbsList.title}"/>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <tr>											
                                           ...
                                           <td class="bbs_date">
												<p>${bbsList.memberNm}</p>
												<p><fmt:formatDate pattern="yyyy-MM-dd" value="${bbsList.regDttm}" /></p>
											</td>
