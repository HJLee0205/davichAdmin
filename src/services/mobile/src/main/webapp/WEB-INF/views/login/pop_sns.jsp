...
<t:insertDefinition name="popupLayout">
    ...
    <script src="/m/front/js/member.js" type="text/javascript" charset="utf-8"></script>
	...
	<link rel="stylesheet" type="text/css" href="${_MOBILE_PATH}/front/css/custom.css" /> <!--- 개발 추가 css ---->
	<!-- //PC버전  -->
    <!--- contents --->
    ...
    <div class="popup_shipping_address_plus" style="height:auto;">
        <div class="popup_header">
            ...
            <button type="button" class="btn_close_popup" onclick="window.close();"><img src="${_MOBILE_PATH}/front/img/common/btn_close_popup.png" alt="팝업창닫기"></button>
        </div>
