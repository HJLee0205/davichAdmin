...
<t:insertDefinition name="davichLayout">
    ...
    function viewVisitInfoDtl(rsvNo,rsvMobile){
        Dmall.FormUtil.submit('${_MOBILE_PATH}/front/visit/nomember-rsv-detail', {'rsvNo':rsvNo,'rsvMobile':rsvMobile});
    }
    </script>
    </t:putAttribute>
                   ...
                   <c:choose>
                       <c:when test="${visit_list.resultList ne null && fn:length(visit_list.resultList) gt 0}">
                           <c:forEach var="visitList" items="${visit_list.resultList}" varStatus="status">
								<tr>
									<th colspan="2">
										<a href="javascript:void(0);" onClick="viewVisitInfoDtl('${visitList.rsvNo}','${visitList.noMemberMobile}');" class="visit_link">
