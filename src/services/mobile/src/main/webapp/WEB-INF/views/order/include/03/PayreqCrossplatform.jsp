    ...
    if($('#LGD_CUSTOM_FIRSTPAY').val() == "SC0010") {
        ...
        Dmall.AjaxUtil.getJSON(url, param, function(result) {
             if(result.success) {
                    ...
                    lgdwin = open_paymentwindow(document.getElementById("frmAGS_pay"), document.getElementById('CST_PLATFORM').value, 'submit');
             }
...
LGD_OSTYPE_CHECK                    <input type="text" name="LGD_OSTYPE_CHECK" id="LGD_OSTYPE_CHECK" value="M"  /><!-- PC에서 모바일모듈 실행방지 --><br />
