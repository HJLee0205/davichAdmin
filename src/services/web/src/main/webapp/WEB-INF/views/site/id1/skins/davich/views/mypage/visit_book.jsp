            ...
            $(document).ready(function () {
                ...
                $('#calendar').fullCalendar({
                    ...
                    dayClick : function (date, allDay, jsEvent, view) {
                        ...
                        // todo : 프로모션 방문예약 체크
                        // todo : 상품 구매 방문 예약 체크
                        // todo : 프로모션 또는 이벤트 방문예약일경우 방문 가능한 날자인지 체크
                        --%>
                        if (isPromotion){
                            if(!checkPromotionTerm(date, promotion.prmtSDate, promotion.prmtEDate, promotion.prmtNm)){
                                return false;
                            }
                        }
            ...
            function getHoliday(storeCode, targetYM) {
                ...
                Dmall.AjaxUtil.getJSON(url, param, function (result) {
                    ...
                    $('[name=goodsNo]').each(function() {
                        ...
                        teanseaonDate.push({
                            color: "#99CCFF",
                            start: promotion.prmtSDate.format('yyyy-MM-dd'),
                            end: promotion.prmtEDate.format('yyyy-MM-dd'),
                    ...
                    <div class="mypage_body">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:choose>
                                    <%-- 프로모션 --%>
                                    <%--                                    <c:when test="${prmtNm  ne null}">--%>
                                    <%--                                        <input type="checkbox" name="purpose_check" id="purpose_check1" value="프로모션" class="order_check" />--%>
                                ...
                                <table class="tCart_Insert">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${member_info eq null}">
                                                <input type="text"  name="nomemberNm" value="${nomemberNm}">
                                            </c:if>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:if test="${member_info ne null}">
                                                <input type="text"  name="nomobile" value="${user.session.mobile}">
                                            </c:if>
                                            <c:if test="${member_info eq null}">
                                                <input type="text"  name="nomobile" value="${nomobile}">
                                            </c:if>
                                        </td>
                                    </tr>
                                    <tr>
