    ...
    $(document).ready(function(){
        ...
        $("#btn_member_leave").click(function () {
            ...
            Dmall.LayerUtil.confirm("정말 탈퇴하시겠습니까?",function() {
                var url = '/front/member/leave-possibility-check';
                var param = $('#form_id_leave').serializeArray();
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                   if(result.success) {
    ...
    <div class="contents fixwid">
        ...
        <div id="category_header">
            <div id="category_location">
                <a href="javascript:history.back();">이전페이지</a><span class="location_bar"></span><a href="/">HOME</a><span>&gt;</span>마이페이지<span>&gt;</span>나의 정보 <span>&gt;</span>회원탈퇴
            </div>
        </div>
        <!---// category header --->
        ...
        <div class="mypage">
            ...
            <div class="mypage_content" id="member_leave_step01">
                ...
                <p style="margin:30px 0 5px">* ${user.session.memberNm} 고객님의 개인정보를 안전하게 보호하기 위해 비밀번호를 다시 한번 확인드립니다.</p>
