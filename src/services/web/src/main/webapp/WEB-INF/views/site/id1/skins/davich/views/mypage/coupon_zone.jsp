...
<t:insertDefinition name="davichLayout">
    <t:putAttribute name="title">다비치마켓 :: 쿠폰존</t:putAttribute>
    ...
    <t:putAttribute name="script">
        ...
        $(document).ready(function(){
            $('#searchCouponOnlineYn, #searchGoodsTypeCd, #searchAgeCd').change(function(){
				...
				var url = '/front/coupon/coupon-zone-ajax';
...
/*            	var param = {couponOnlineYn : couponOnlineYn, goodsTypeCd : goodsTypeCd, ageCd : ageCd};
            	Dmall.FormUtil.submit('/front/coupon/coupon-zone', param);*/
        ...
        function drtIssueCoupon(couponNo) {
            ...
            var url = '/front/coupon/coupon-issue?drtCpIssuYn=Y';
        ...
        function issueCouponAll() {
            ...
            if(couponAvailCnt > 0) {
                var url = '/front/coupon/coupon-zone-issue-all';
                var param = {};
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                    if(result.success) {
    ...
    <t:putAttribute name="content">
		<div class="category_middle">
			<h2 class="zone_tit"><img src="${_SKIN_IMG_PATH}/mypage/coupon_tit.gif" alt="쿠폰존 쿠폰도 쇼핑하자"></h2>

			<!-- 목록 영역 -->
			<div class="zone_area">
				<div class="zone_top_area">
					<button type="button" class="btn_all_zone" onclick="issueCouponAll();">전체받기<i></i></button>
					<a href="/front/coupon/coupon-list"><button type="button" style="margin-left: 20px;" class="btn_all_zone">내 보유 쿠폰</button></a>
