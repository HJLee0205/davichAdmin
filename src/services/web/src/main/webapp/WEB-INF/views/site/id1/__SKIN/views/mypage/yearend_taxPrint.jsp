...
<t:insertDefinition name="popupLayout">
	<t:putAttribute name="title">다비치마켓 :: 연말정산</t:putAttribute>
    ...
    jQuery(document).ready(function() {
		...
		$(".btn_presc_registration").on("click", function(){
			
			   var initBody = document.body.innerHTML;
               window.onbeforeprint = function(){
                   document.body.innerHTML = document.getElementById('cash_bill').innerHTML;
               }
...
<t:putAttribute name="content">
	...
	<div class="btn_davichi_area">
		<button type="button" class="btn_presc_registration">출력하기</button>
	</div>
    <!---// popup 배송지 추가/수정 --->
    </t:putAttribute>
</t:insertDefinition>