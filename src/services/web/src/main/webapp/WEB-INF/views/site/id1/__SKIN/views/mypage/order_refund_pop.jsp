...
<div class="popup_content_scroll">
    ...
    <table class="tMypage_Board">
        <caption>
            <h1 class="blind">반품신청 상품 목록 입니다.</h1>
        </caption>
        <colgroup>
        ...
        <tbody>
            ...
            <c:if test="${goodsList.rsvOnlyYn ne 'Y'}">
               ...
               <c:if test="${goodsList.ordQtt > goodsList.claimQtt}">
                <tr data-ord-qtt="${goodsList.ordQtt}" data-ord-no="${goodsList.ordNo}"  data-ord-dtl-seq="${goodsList.ordDtlSeq}">
                    <td>
                        <c:choose>
                            <c:when test="${goodsList.ordQtt > goodsList.claimQtt}">
                                <div class="mypage_check">
                                    <input type="checkbox" class="order_check" name="itemNoArr" id="itemNoArr_${status.index}">
                        ...
                        <ul class="mypage_s_list">
                            ...
                            <li>
                                <div class="select_box28" style="width:270px;margin-top:5px">
                                    <label for="claimReasonCd_${status.index}">반품사유</label>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${goodsList.ordQtt > goodsList.claimQtt}">
                                ...
                                <select name="claimQtt" id="claimQtt_${status.index}" style="width:80px;">
   ...
   <%-- <h3 class="mypage_con_stit">반품 사유</h3>
    <table class="tMypage_Board" style="border:none">
        <caption>
            <h1 class="blind">반품 사유 등록 폼 입니다.</h1>
        </caption>
        <colgroup>
            <col style="width:">
        </colgroup>
            ...
            <tbody>
                ...
                <c:if test="${orderVO.orderInfoVO.memberOrdYn eq 'Y'}">
                    <c:if test="${!empty refund_account.data.holderNm}">
                        ...
                        <input type="hidden" id="bankCd" name="bankCd" value="${refund_account.data.bankCd}"/>
...
<div class="popup_btn_area">
    <button type="button" class="btn_mypage_ok" onclick="claim_refund();">반품신청</button>
</div>
<!---// popup 반품신청 --->