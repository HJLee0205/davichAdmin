...
<c:if test="${popupList.popupGbCd eq 'L'}">
   <c:if test="${popupList.popupGrpCd eq 'MM'}">
        <div class="popup_main_day" id="layerPopup_${status.index}" style="width:${popupList.widthSize}px; height:auto; left:${popupList.pstLeft}px; top:${popupList.pstTop}px; display:none; position:absolute;">
            <div class="popup_close">
                <button type="button" class="btn_close_popup" style="z-index:1000"><img src="/front/img/common/btn_close_popup.png" style="height:20px;height:20px;" alt="팝업창닫기"></button>
            </div>
