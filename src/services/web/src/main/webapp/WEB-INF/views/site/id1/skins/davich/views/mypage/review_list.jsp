...
<t:insertDefinition name="davichLayout">
	<t:putAttribute name="title">다비치마켓 :: 상품후기</t:putAttribute>
                                ...
                                <c:when test="${resultModel.lvl eq '0' || resultModel.lvl eq null}" >
                                    ...
                                    <tr class="hide">
                                        <td colspan="7" class="review_view">
                                            ...
                                            <img id="imgFile" src="${_IMAGE_DOMAIN}/image/image-view?type=BBS&path=${resultModel.imgFilePath}&id1=${resultModel.imgFileNm}" width="100px" height="100px;">
                                            </c:if>
                                            ${resultModel.content}
