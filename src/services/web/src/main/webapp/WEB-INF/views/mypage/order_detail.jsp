                ...
                <div class="payment_info_area">
                    <ul class="payment_info">
                        ...
                        <li class="icon">
                         ...
                         <li>
                            사용 마켓포인트
                            <span><fmt:formatNumber value='${sumMileage}' type='number'/>원</span>
                        </li>
                        <li class="icon">
                ...
                <table class="tMypage_Board">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text12L">${orderPayVO_Bank.bankNm}&nbsp;${orderPayVO_Bank.actNo}&nbsp;(입금자:${orderPayVO_Bank.holderNm})</td>
                        </tr>
                        <tr>
                            <th class="textL">입금할 금액</th>
                            <td class="text12L">
                                <em><fmt:formatNumber value='${orderPayVO_Bank.paymentAmt}' type='number'/> 원</em>
                ...
                <table class="tMypage_Board">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text12L">${order_info.orderInfoVO.adrsTel} / ${order_info.orderInfoVO.adrsMobile}</td>
                        </tr>
                        <tr>
                ...
                <div class="btn_area">
                    ...
                    <c:forEach var="orderPayVO" items="${order_info.orderPayVO}" varStatus="status">
                        <c:if test="${orderPayVO.paymentWayCd eq '23'}">
                            <!-- 신용카드영수증 조회 -->
                            <input type="hidden" id="realServiceYn" value="${realServiceYn}" readonly="readonly"/><BR>
                            <input type="hidden" name="pgCd" id="pgCd" value="${orderPayVO.paymentPgCd}" readonly="readonly"/><BR>
                            <input type="hidden" id="confirmNo" value="${orderPayVO.confirmNo}" readonly="readonly"/><BR>
                    ...
                    <button type="button" class="btn_prev_page" id="goto_back">이전 페이지로</button>
                </div>
            </div>
            <!---// 마이페이지 오른쪽 컨텐츠 --->
            <!--- popup 현금영수증 발급신청 --->
