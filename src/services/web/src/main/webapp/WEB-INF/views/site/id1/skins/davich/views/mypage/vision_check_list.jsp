						...
						<c:choose>
							<c:when test="${empty glassVision}">
								<div class="lens_recomm result">
									...
									<!-- 
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision/vision-check';">지금 추천받기<i></i></button>
									 -->
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision2/vision-check';">지금 추천받기<i></i></button>
								</div>
							</c:when>
							<c:otherwise>					
								...
								<div class="lens_recomm result">
									...
									<!-- 
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision/vision-check?lensType=G';">렌즈추천 다시받기<i></i></button>
									 -->
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision2/vision-check?visionGb=G';">렌즈추천 다시받기<i></i></button>
								</div>
									...
									<c:forEach var="result" items="${glassVision}" varStatus="status">
										<li>
											<p class="tit">
												...
												<label for="lens_check_g${status.count}">${result.checkNm}<span></span></label>
											</p>				
					...
					<div class="tabs_vision_content" id="tab02" <c:if test="${lensType eq 'G' }">style="display:none;"</c:if> >
						<c:choose>
							...
							<c:otherwise>
								...
								<div class="lens_recomm result">
									<c:choose> 
										<c:when test="${empty topContactVO.resultAll}">
										...
										<c:otherwise>${topContactVO.resultAll}</c:otherwise>
									</c:choose>
									<!-- 
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision/vision-check?lensType=C';">렌즈추천 다시받기<i></i></button>
									 -->
									<button type="button" class="btn_recom_again" onclick="document.location.href='/front/vision2/vision-check?visionGb=C';">렌즈추천 다시받기<i></i></button>
								</div>
								...
								<ul class="lens_result">
									...
									<li>
										<p class="tit">
											...
											<label for="lens_check_c${status.count}">${result.checkNm}<span></span></label>
										</p>				
										<p class="text">${result.simpleDscrt}</p>
										<input type="hidden" name="imgNm" value="${result.imgNm}">
										<button type="button" class="btn_view_lens">자세히보기</button>
