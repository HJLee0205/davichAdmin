...
<link rel="stylesheet" type="text/css" href="/front/css/custom.css?dt=${nowDate}" /> <!--- 개발 추가 css ---->
...
<script type="text/javascript" src="/front/js/html5shiv.printshiv.js"></script>
<script type="text/javascript" src="/front/js/IE9.js"></script>
<![endif]-->
<!--[if (gte IE 6)&(lte IE 8)]>
<script id="selectivizr" type="text/javascript" src="/front/js/selectivizr.js"></script>
...
<script src="/front/js/lib/jquery/jquery.cookie.js" charset="utf-8"></script>
<script src="/front/js/lib/jquery/jquery.mask.min.js" charset="utf-8"></script>
<script src="/front/js/lib/jquery/jquery.form.min.js" charset="utf-8"></script>
<script src="/front/js/lib/jquery/jquery.blockUI.js" charset="utf-8"></script>

<script src="/front/js/common.js?dt=${nowDate}" charset="utf-8"></script>
<script src="/front/js/custom.js?dt=${nowDate}" charset="utf-8"></script>
<script src="/front/js/layer.js?dt=${nowDate}" charset="utf-8"></script>
<script src="/front/js/link.js?dt=${nowDate}" charset="utf-8"></script>
<script src="/front/js/paging.js?dt=${nowDate}" charset="utf-8"></script>
<script src="/front/js/cookie.js?dt=${nowDate}" charset="utf-8"></script>
<script type="text/javascript" src="//wcs.naver.net/wcslog.js"></script>
<script type="text/javascript" src="/front/js/masonry.pkgd.min.js"></script><!-- 디매거진 -->

<%-- Jquery Validation Engine --%>
<link type="text/css" rel="stylesheet" href="/front/js/lib/jquery/validation-Engine-2.6.2/css/validationEngine.jquery.css" />
<script src="/front/js/lib/jquery/validation-Engine-2.6.2/js/jquery.validationEngine.js" charset="utf-8"></script>
<script src="/front/js/lib/jquery/validation-Engine-2.6.2/js/languages/jquery.validationEngine-ko.js" charset="utf-8"></script>
<script type="text/javascript" src="/front/js/lib/jquery/jquery.mCustomScrollbar.concat.min.js"></script>
<script type="text/javascript" src="/front/js/lib/jquery/jquery.carouFredSel-6.2.1-packed.js"></script>
<!-- <script src="/front/js/lib/jquery.bxslider.min.js"></script> -->
<script src="/front/js/lib/jquery.bxslider.js"></script>
<script src="/front/js/lib/html2canvas.js"></script>
...
<%
   // 상품상세페이지, 기획전에만 노출
   if(uri.matches(".+(goods_detail|promotion_view)[.]jsp")){
%>
