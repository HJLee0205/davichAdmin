        ...
        <div class="contents fixwid">
            ...
            <div id="category_header">
                <div id="category_location">
                    <a href="javascript:history.back() return false;">이전페이지</a><span class="location_bar"></span><a href="/">HOME</a><span>&gt;</span>마이페이지<span>&gt;</span>나의 혜택 <span>&gt;</span>나의 다비치포인트
                </div>
            </div>
            <!---// category header --->
                ...
                <div class="mypage_content">
                    <form:form id="form_id_list" commandName="so">
                        ...
                        <h3 class="mypage_con_stit" style="margin-bottom:30px">
                            현재 누적 다비치포인트 : <em><fmt:formatNumber value="${point}" type="currency" maxFractionDigits="0" currencySymbol=""/>P</em>
                            <span class="my_emoney_info_text">다비치포인트는 로그인, 출석체크 시 등급 산정의 기준이 되는 쇼핑지수로 상품구매시 사용이 불가능합니다.</span>
                        </h3>
                        ...
                        <table class="tCart_Board">
                            <caption>
                                <h1 class="blind">나의 다비치포인트 내용입니다.</h1>
                            </caption>
                            <colgroup>
                                <col style="width:7%">
                                <col style="width:20%">
