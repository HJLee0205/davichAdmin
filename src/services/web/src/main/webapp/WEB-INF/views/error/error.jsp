        ...
        <div class="error">
            <div class="error_box">
                <h1 class="error_logo">
                    ...
                    <img src="/image/image-view?type=LOGO&id1=logo.png" alt="LOGO">
                    </c:if>
                    <c:if test="${!empty site_info.logoPath}">
                    <img src="${site_info.logoPath}" alt="LOGO" onerror="this.src='/front/img/common/logo/logo.png'">
                    </c:if>
                </h1>
                ...
                <div class="btn_area" style="height:100px">
                    <button type="button" class="btn_error_prev" style="margin-right:6px">이전페이지로</button>
                    <button type="button" class="btn_error_main">메인페이지로</button>
                </div>
            </div>
