	...
	<t:putAttribute name="script">
        ...
        $(document).ready(function(){
            ...
            $('#btn_id_search').on('click', function() {
                ...
                Dmall.FormUtil.submit('/front/customer/board-list?bbsId=${so.bbsId}', param);
            });
            ...
            if(readLettContentUseYn == "Y") {
                ...
                Dmall.AjaxUtil.getJSON(url, param, function(result) {
                    if(result){
                    	...
                    	location.href = '/front/customer/letter-detail?bbsId=${so.bbsId}&lettNo='+lettNo;
                    }
                });
            } else {
                    ...
                    <c:when test="${bbsInfo.data.readListUseYn eq 'Y' }">
                        ...
                        <form:form id="form_id_search" commandName="so">
                            ...
                            <div class="table_top">
                                ...
                                <input type="text" name="searchVal" id="searchVal" value="${so.searchVal}"><button type="button" id="btn_id_search" class="search_btn">검색</button>
                            </div>

                            <table class="tFree_List">
                                <caption>
                                        ...
                                        <c:forEach var="bbsList" items="${resultListModel.resultList}" varStatus="status">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="bbs_keyword">${bbsList.titleNm}</span>
                                                    </c:if>
                                                </td>
                                                </c:if>
                                                <td class="textL">
