    ...
    <table class="tMypage_Board">
        ...
        <tbody>
            ...
            <tr data-ord-no="${goodsList.ordNo}"  data-ord-dtl-seq="${goodsList.ordDtlSeq}">
                ...
                <td>                   
					<input class="order_check" type="checkbox" name="itemNoArr" id="itemNoArr_${status.index}" ${disabled}>
            ...
            <tbody>
                ...
                <c:if test="${orderVO.orderInfoVO.memberOrdYn eq 'Y'}">
                    ...
                    <c:if test="${empty refundModel.data}">
                        <tr>
                            <td colspan="3"><a href="/front/member/refund-account">등록된 환불 계좌가 없습니다.(환불/입금계좌 관리에서 등록해주세요)</a></td>
                        </tr>
                    </c:if>
                </c:if>
