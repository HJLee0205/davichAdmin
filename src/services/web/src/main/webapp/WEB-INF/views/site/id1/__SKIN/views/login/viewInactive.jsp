		...
		<script>
			jQuery(document).ready(function() {
				...
				$("#email_confirm,#mobile_confirm").click(function(){
					...
					//var url = '/front/login/account-detail';
					var url = '/front/login/inactive-member-detail';
					var param = {
                    ...
                    Dmall.AjaxUtil.getJSON(url, param, function(result) {
						if(result.length > 0) {
							...
							$("#loginId").val(result[0].loginId);
							 var url = '/front/login/send-cetifyvalue';
                ...
                $('#number_confirm_email,#number_confirm_mobile').on('click', function () {
                    ...
                    Dmall.AjaxUtil.getJSON(url, param, function(result) {
                        if(result.success) {
                            if(push_agreeYn=="Y"){
                                var url = "/front/member/app-info-collect";
	...
	<t:putAttribute name="content">
		...
		<%--<div class="contents fixwid">
			...
			<div class="inactivity_login_box">
       		...
       		<!---// contents --->
       		&lt;%&ndash;<form name="reqDRMOKForm" method="post">
