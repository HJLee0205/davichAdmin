   		...
   		<!--- 마이페이지 왼쪽 메뉴 --->
            ...
            <div class="mypage_body">
				...
				<div class="order_cancel_info">
					...
					<span class="icon_purpose">지정하신 계좌로 주문취소/반품시 환불금액을 입금해 드립니다.</span>
				</div>
            ...
            <table class="tProduct_Insert" style="margin-top:5px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width:232px;" id="actNo" name="actNo" value="${resultModel.actNo}" onKeydown="return onlyNumDecimalInput(event);"></td>
                    </tr>
                </tbody>
            </table>
            </form>
