...
<t:insertDefinition name="davichLayout">
    <t:putAttribute name="title">다비치마켓 :: 19금 상품안내</t:putAttribute>
    ...
    <script>
        $(document).ready(function(){
            $('#btn_adult_certification').on('click',function(){
               location.href="/front/member/information-update-form";//회원정보 수정페이지이동
            });
            $('#btn_move_main').on('click',function(){
                location.href="/front/main-view";//메인페이지이동
             });
        });
    </script>
    </t:putAttribute>
    ...
    <div class="contents fixwid">
        ...
        <div class="inactivity_login_box">
            <div class="inactivity_text01">
                <p><img src="/front/img/common/img_adult.png"></p>
