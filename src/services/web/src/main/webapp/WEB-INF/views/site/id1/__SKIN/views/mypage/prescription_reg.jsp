...
$(function () {
	...
	// Date Picker 설정
	$("#prescriptionPop .datepicker").datepicker({
		dateFormat: "yy-mm-dd"
	});

	// X버튼, 취소 버튼 클릭시 팝업 숨기기
	$("#prescriptionPop").find(".btn_close_popup, .btn_close_popup02").click(function() {
		$("#prescriptionPop").hide();
	});
	
	// 확인 버튼 클릭
	$("#btn_reg_prescription").on("click", function() {
// 	$(document).off("click", "#btn_reg_prescription");
// 	$(document).on("click", "#btn_reg_prescription", function() {
        ...
        $('#prescriptionForm').ajaxSubmit({
            url : "/front/mypage/prescription_reg",
            dataType : 'json',
