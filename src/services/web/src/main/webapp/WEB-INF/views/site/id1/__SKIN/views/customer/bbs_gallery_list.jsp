                                        ...
                                        <c:forEach var="bbsList" items="${resultListModel.resultList}" varStatus="status">
                                            ...
                                            <c:choose>
                                                <c:when test="${bbsList.imgFilePath ne null}">
                                                    <c:set var="bbsImg" value="<img src='${_IMAGE_DOMAIN}/image/image-view?type=BBS&path=${bbsList.imgFilePath}&id1=${bbsList.imgFileNm}'  alt=''>"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <c:set var="bbsImg" value="<img src='../img/community/gallery_img01.gif' alt=''>"/>
                                                </c:otherwise>
                                            </c:choose>
                                            <li>
