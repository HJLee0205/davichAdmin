...
<t:insertDefinition name="davichLayout">
	<t:putAttribute name="title">다비치마켓 :: 가입완료</t:putAttribute>
    ...
    <script>
		$(document).ready(function(){
            ...
            $("#bcTarget").barcode("${po.memberCardNo}", "code128", {barWidth: 2,barHeight: 50});
    ...
    <div id="member_container">
        <h3 class="member_sub_tit">"다비치마켓 회원이 되신 것을 진심으로 환영합니다."<br><br></h3>
        <div class="card_area">
            <div class="member_card_name">DAVICH Membership</div>
            <div class="member_barcode">
				<div class="member_name"><em>${po.memberNm}</em>님</div>
            ...
            <li>
                <div class="box">
                    ...
                    <div class="text_area">
                        ...
                        검사-구매정보 및 AS 가능<br>
                        Caffe & daon 1일 1회 무료이용(동반 1인까지)<br>
                    </div>
                </div>
            </li>
            <li>
