...
<ul class="product_faq_box">
    <li class="tit">
        <h3 class="product_faq_tit">NOTICE</h3>
    </li>
    <li class="text">
        <ul>
            <li>해당 상품정보를 보시고 난 후 궁금한 사항을 문의하실 수 있습니다.</li>
            <li>질문에 대한 답변내역은 마이페이지에서도 확인하실 수 있습니다.</li>
            <li>상품에 관한 문의가 아닌 배송, 결제, 교환/반품 등에 대한 문의는 “고객센터 1:1문의”를 이용하시기 바랍니다.</li>
            <li class="btn"><button type="button" class="btn_gocenter" onclick="location.href='/front/customer/customer-main';">고객센터 바로가기</button></li>
        </ul>
    </li>
</ul>
...
<div class="product_table_top">
    <span class="list_text_no">* 총 <em>${questionList.filterdRows}</em>건의 상품문의가 있습니다</span>
    <button type="button" class="btn_write_faq" id="btn_write_question">상품문의하기</button>
</div>
