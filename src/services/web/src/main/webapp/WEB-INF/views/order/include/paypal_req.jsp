...
<script type="text/javascript">
    var PayPalUtil = {
        returnUrl:location.protocol + '//' + location.host + '/front/order/paypal-result'
        , openPaypal:function() {
        ...
        , getHashData:function(vo) {
            var url = '/front/order/paypal-hashdata-info',
            dfd = jQuery.Deferred();
...
<!-- <form id="paypal_info" method="post" action="http://www.davichmarket.com/front/order/paypal-result"> --> <!-- 테스트 -->
    <input type="hidden" name="mid"                 value="${foreignPaymentConfig.data.frgPaymentStoreId}">
    <input type="hidden" name="timestamp"           value="">
    <input type="hidden" name="webordernumber"      value="${ordNo}">
    ...
    <input type="hidden" name="shiptostate"         value="SA">
    <input type="hidden" name="shiptocountrycode"   value="kr">
