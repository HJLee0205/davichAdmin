...
<t:insertDefinition name="previewLayout">
    <t:putAttribute name="title">상품상세 미리보기</t:putAttribute>
    <sec:authentication var="user" property='details'/>
    <t:putAttribute name="content">
    <div class="contents">
    <!--- // 00.Script --->
    <%@ include file="/WEB-INF/views/goods/goods_edit_preview_js.jsp" %>
    ...
    <div id="category_header">
        <div id="category_location">
            <a href="">이전페이지</a><span class="location_bar"></span><a href="">HOME</a><span>&gt;</span>
            ...
            <div class="category_selectBox select_box" style="width:120px;">
                ...
                <select class="select_option" title="select option" id="navigation_combo_${status.index}" disabled="disabled">
    ...
    <div id="product_bottom">
        ...
        <!--- tab03: 상품문의 --->
        <div class="tab_content" id="tab3"></div>
        <!---// tab03: 상품문의 --->

        <!--- tab04: 배송/반품/환불 --->
        <div class="tab_content" id="tab4"></div>
        <!---// tab04: 배송/반품/환불 --->
