...
$(document).ready(function() {
    $('.btn_mypage_ok').on('click', function() {
        Dmall.LayerPopupUtil.close("div_order_cancel_layer");
    });
});
</script>
<div class="popup_header">
    <h1 class="popup_tit">
        ${orderVO.resultList[0].orderInfoVO.titleInfo}상세내역
    </h1>
...
<div class="popup_content_scroll" style="height:307px">
    <c:forEach var="orderVO" items="${orderVO.resultList}" varStatus="status">
    ...
    <table class="tMypage_Board">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="textL">
                    ...
                    <c:forEach var="goodsList" items="${orderVO.orderGoodsVO}" varStatus="status">
                        ${goodsList.goodsNm} [기본옵션- ${goodsList.itemNm} ] ${orderVO.orderInfoVO.claimQtt}개
                    <em><fmt:formatNumber value='${orderVO.orderInfoVO.claimQtt * goodsList.saleAmt-goodsList.dcAmt}' type='number'/></em>원
                    <p>
                            <c:set var="sumPayAmt" value="${sumPayAmt + goodsList.payAmt}"/>
                            <c:set var="refundAmt" value="${refundAmt + (goodsList.claimQtt * goodsList.saleAmt-goodsList.dcAmt)}"/>
                        </c:forEach>
                </td>
            </tr>
            <tr id= "claimDtlReason">
                ...
                <td class="textL">
                	<code:unescape value="${orderVO.orderInfoVO.claimDtlReason}"></code:unescape>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="tMypage_Board" id="cancleInfoTable" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="textL" id=""><em><fmt:formatNumber value='${refundAmt}' type='number'/></em>원
