...
<t:insertDefinition name="davichLayout">
    <t:putAttribute name="title">다비치마켓 :: 입점/제휴문의</t:putAttribute>
    ...
    <t:putAttribute name="content">
         ...
         <!--- 02.LAYOUT: 카테고리 메인 --->
    <div class="category_middle seller_wrap">
		<div class="com_head">
			<h2 class="com_tit">입점/제휴문의</h2>
		</div>
		<div class="partnership_info_area">
			<p>다비치마켓은 국내 최대 안경매장을 기반으로 한 O4O 쇼핑 플랫폼 기반의 종합 쇼핑몰 입니다.<br>
			다비치마켓에 입점을 원하시는 분들은 아래 내용을 참고하신 후, 상담 요청을 각 항목에 맞게 작성 부탁드립니다.</p>
			<img src="${_SKIN_IMG_PATH}/company/seller_img.jpg" class="seller_img">
			<dl class="list_type2">
				<dt>특징</dt>
				<dd>- 구매력이 강한 양질의 회원보휴</dd>
				<dd>- 타사몰 대비 합리적이고 저렴한 수수료</dd>
				<dd>- 기존 회원이 보유한 다비치포인트 & 쿠폰사용</dd>
				<dd>- 유사성이 매우 높은 연계상품 카테고리 구성으로 즉시구매율 증대</dd>
				<dd>- 고객관리 운영 노하우 (32년간)가 적용된 체계적인 고객관리 (빅데이터 보유) 시스템 </dd>
			</dl>
		</div>
		...
		<form id="form_id_sellerDtl" method="post">
			...
			<table class="tInsert">
				...
				<tbody>
					...
					<tr>
						<th class="vaT">개인정보수집동의</th>
						<td>
							<input type="checkbox" id="agree_check01" name="marketing" class="agree_check">
							<label for="agree_check01"><span></span>수집하는 개인정보 항목, 수집/이용목적, 개인정보 보유기간에 동의합니다.</label>
