...
<t:insertDefinition name="davichLayout">
    <t:putAttribute name="title">다비치마켓 :: 아이럽 라이트 사전예약</t:putAttribute>
    ...
    <t:putAttribute name="content">
		...
		<br>
			...
			<input type="hidden" name="eyeluvYn" id="eyeluvYn" value="Y">
			<input type="hidden" name="ch" id="ch" value="${so.ch eq null?"TSE03-00":so.ch}">
        	...
        	<img src="${_SKIN_IMG_PATH}/event/eyeluvevent.jpg" alt="아이럽 라이트 사전 예약 이벤트">
			...
			<a href="javascript:;" id="btn_non_visit">
				<img src="${_SKIN_IMG_PATH}/event/event_tensean07.jpg"  alt="아이럽 라이트 사전 예약하기">
			</a>
		</div>
		</form>
        	<!-- 비회원 방문예약신청시 -->
