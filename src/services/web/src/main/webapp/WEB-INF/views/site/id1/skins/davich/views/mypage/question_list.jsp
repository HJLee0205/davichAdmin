...
<t:insertDefinition name="davichLayout">
	<t:putAttribute name="title">다비치마켓 :: 상품문의</t:putAttribute>
    ...
    $(document).ready(function(){
        ...
        $('#btn_id_search').on('click', function() {
            ...
            Dmall.FormUtil.submit('/front/question/question-list', param);
        });
        //페이징
        ...
        $('.btn_review_ok').on('click', function() {
            ...
            Dmall.AjaxUtil.getJSON(url, param, function(result) {
                if(result.success) {
                    ...
                    location.href= "/front/question/question-list";//목록화면 갱신
                }
            });
        });
        /* 상품문의수정 팝업 닫기*/
    ...
    function deleteQuestion(idx){
        Dmall.LayerUtil.confirm('상품문의를 삭제하시겠습니까?', function() {
            ...
            Dmall.AjaxUtil.getJSON(url, param, function(result) {
                 if(result.success) {
                     location.href= "/front/question/question-list";
                 }
            });
        })
    }
    ...
    <div class="contents fixwid">
        <div id="mypage_location">
            <a href="javascript:history.back();">이전페이지</a><span class="location_bar"></span><a href="">HOME</a><span>&gt;</span>마이페이지<span>&gt;</span>나의 활동 <span>&gt;</span>상품문의
        </div>
    ...
    <div id="popup_question_write" style="display: none;">
        ...
        <div class="popup_content">
            <form id="form_id_update" action="/front/question/question-update">
