...
<script>
    ...
    <div class="popup_my_shipping_address">
        ...
        <div class="popup_content">
            <div class="popup_address_scroll" style="height:380px;">
                    ...
                    <c:choose>
                        <c:when test="${resultListModel.resultList ne null}">
                            <c:forEach var="deliveryList" items="${resultListModel.resultList}" varStatus="status" end="4">
                                ...
                                <tr data-mobile="${deliveryList.mobile}" data-tel="${deliveryList.tel}" data-membergbcd="${deliveryList.memberGbCd}" data-adrsNm="${deliveryList.adrsNm}"
