    ...
    $.fn.coupon = function(options) {
        ...
        var createPop = (function(){
            ...
            var _order_qtt = 0;
                $.ajax({
                    type : "POST",
                    url : "/front/coupon/available-ordercoupon-list",
                    ...
                    success : function(data){
                        ...
                        $.each(settings.params, function (i){
                           if(settings.params[i].rsvOnlyYn!='Y'){
                        ...
                        $.each(data.resultList, function (j){
                            if(data.resultList[j].goodsNo == "" || data.resultList[j].goodsNo == null) {
                                ...
                                couponOrderList += "            data-coupon-kind-cd='"+data.resultList[j].couponKindCd+"' data-apply-start-dttm='"+data.resultList[j].applyStartDttm+"' data-apply-end-dttm='"+data.resultList[j].applyEndDttm+"' data-coupon-solo-use-yn='"+data.resultList[j].couponSoloUseYn+"'>";
                        ...
                        htmlCouponPopup += "            </div>";*/
                        htmlCouponPopup += "            <ul class='popup_coupon_price' style='display: none;'>";
                        htmlCouponPopup += "                <li style='display: none;'>";
                        htmlCouponPopup += "                    상품쿠폰<span id='goodsCouponAmt' data-goods-coupon-amt='0'>0원</span>";
                        htmlCouponPopup += "                </li>";
                        htmlCouponPopup += "                <li class='icon' style='display: none;'>";
                        ...
                        documentCouponPopup.find(".btn_my_coupon").click(function(){
                            window.open('/front/coupon/coupon-list','_blank');							
                        });
