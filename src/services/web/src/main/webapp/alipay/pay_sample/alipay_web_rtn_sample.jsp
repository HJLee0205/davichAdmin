...
FILE NAME : alipay_web_rtn_sample.jsp
DATE : 2014/09
Author : MI1
Description :   Alipay Response Test Page
                http://www.inicis.com
...
<%
    ...
    if("00".equals(result.get("resultcode")))
        resultCheck = "알리페이로 부터 결제 결과 확인중입니다.";
    else
        resultCheck = "결제가 정상처리되지 못했습니다. 다시 한번 결제 시도해 주시기 바랍니다.";

    //응답된 결제 데이터를 이용하여 상점 비지니스 로직을 처리하시기 바랍니다.
                            ...
                            <tr>
                                <td width="510" colspan="2"  style="padding:0 0 0 23">
                                    ...
                                    <table width="470" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td width="18" align="center"><img src="img/icon02.gif" width="7" height="7"></td>
                                            <td width="109" height="25">APAYAUTHDATE</td>
                                            <td width="343">
                                                &nbsp; : &nbsp;<%=result.get("apayauthdate")%>
                                            </td>
                                        </tr>
