...
<%
/*******************************************************************************
 * FILE NAME : apayinput_hash.jsp
 * DATE : 2014.09
 * 이니시스 알리페이 결제 결과 통보를 받는 샘플 페이지입니다.
 * [수신정보] 자세한 내용은 메뉴얼 참조
 * 변수명           한글명                           
 * P_TID        TID
 * P_MID        상점아이디
 ...
 ***********************************************************************************/	
	...
	String file_path = "/usr/local/tomcat/apache-tomcat-5.5.31/webapps/INIpay";
    ...
    hash_key = "1234567890";//해시값 사용 필요시 별도 문의
    hash_chk = "";//해쉬 검증 결과값
...
<%!
    ...
    private void writeLog(String file_path) throws Exception
    {
        ...
        FileWriter file2 = new FileWriter(file_path+"/apayinput_"+getDate()+".log", true);
