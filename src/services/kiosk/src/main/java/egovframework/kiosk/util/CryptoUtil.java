...
public class CryptoUtil {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(CryptoUtil.class);
    ...
    @PostConstruct
    public void init() {
        CryptoUtil.aes_key = propertiesService.getString("core.encryption.aes.key");;
        CryptoUtil.aes_iv = propertiesService.getString("core.encryption.aes.iv");;
        CryptoUtil.des_key = propertiesService.getString("core.encryption.des.key");;
        CryptoUtil.desede_key = propertiesService.getString("core.encryption.desede.key");;
    }
    ...
    private static String getMessageDigest(String algorithm, String value) {
        ...
        try {
            ...
            logger.error("biz.exception.system.noSuchAlgorithm", e);
        }
